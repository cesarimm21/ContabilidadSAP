...
export default [
 
  {
    ...
    children:[
      ...
      {
        path:'FI-FINANZAS/libros-balance/registro-inventario-unidad-fisica',
        component:RegistroInventarioUnidadFisicaComponent,
        name:'RegistroInventarioUnidadFisicaComponent'
      }, 
