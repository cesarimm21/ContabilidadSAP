    ...
    <div class="modificar-po">
        ...
        <el-card class="box-card">
            <div slot="header" class="headercard">
                <span class="labelheadercard" >Modificar Pagos</span>
            </div>
...
<script>
import ModificarPagosComponent from '@/components/FI-FINANZAS/Tesoreria/edit_pagos/edit_pagos.component'
export default ModificarPagosComponent
</script>
<style scoped>
.sinLinea{
