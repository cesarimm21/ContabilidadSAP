    ...
    <div class="modificar-po">
        ...
        <el-card class="box-card">
            <div slot="header" class="headercard">
                <span class="labelheadercard" >Aprobar Pagos</span>
            </div>
...
<script>
import AprobarPagosComponent from '@/components/FI-FINANZAS/Tesoreria/aprobar_pagos/aprobar_pagos.component'
export default AprobarPagosComponent
</script>
<style scoped>
.sinLinea{
