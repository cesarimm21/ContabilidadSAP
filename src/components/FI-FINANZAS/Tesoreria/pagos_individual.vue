            ...
            <div class="row bodycard">
                <div class="col-md-6">
                    ...
                    <div class="col-sm-4 grupolabel">
                        ...
                        <el-input type="text"  size ="small" v-model="compania.strCompany_Cod" style="font-size:11px;" disabled></el-input>
                        </div>
                    </div>
                    <label class="sinLinea el-form-item__label col-sm-5" >{{compania.strCompany_Name}}</label>
                    </div>
                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        <label class="el-form-item__label col-sm-5" >Banco pagador:</label>
                                            <div class="col-sm-3 grupolabel">
                                                <div class="input-group mb-3" >
                                                <el-input size ="small" @blur="desactivar_banco" @focus="activar_banco" >                            
