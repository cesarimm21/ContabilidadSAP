...
export default class VisualizarContabilidadComponent extends Vue {
    ...
    if(this.selectrow!=undefined && this.selectrow!=null ){
      ...
      await setTimeout(() => {
        ...
        if(this.selectrow!=undefined && this.selectrow!=null ){
          ...
          router.push({ path: `/barmenu/FI-FINANZAS/contabilidad-general/modificar-contabilidad`, query: { vista: 'visualizar',data:JSON.stringify(this.selectrow) }  })
        }
      }, 600)
    }
    else{
