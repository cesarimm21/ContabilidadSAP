                    ...
                    <div class="row" style="margin-top: 3px;">
                        <div class="col-sm-9">
                            ...
                            <div class="form-group row ">
                                ...
                                <el-checkbox :disabled="visualizar" class="newCheckBox"  v-model="Auto">
                                </el-checkbox> 
                            </div>   
                            <div class="form-group row">
                                                ...
                                                <el-table
                                                    ...
                                                    <el-table-column   prop="strCateg_Account" min-width="80" label="Cat. Cuenta">
                                                        <template scope="scope">
                                                            <el-input :disabled="visualizar"   v-if="bln_tbl_categoria_cuenta  && (scope.row === editing.row) 
                                                    ...
                                                    <el-table-column  align="right"
                                                        ...
                                                        label="Debe">
                                                        <template scope="scope">
                                                            <el-input-number :disabled="visualizar" @change="cambiarCantidadDebe(scope.row)"   v-if="bln_tbl_cantidad_debe  && (scope.row === editing.row) 
                                                    ...
                                                    <el-table-column  align="right"
                                                        ...
                                                        label="Haber">
                                                        <template scope="scope">
                                                            <el-input-number :disabled="visualizar"  @change="cambiarCantidadHaber(scope.row)"  v-if="bln_tbl_cantidad_haber  && (scope.row === editing.row) 
...
import ModificarContabilidadComponent from '@/components/FI-FINANZAS/contabilidad-general/modificar-contabilidad/modificar-contabilidad.component'
export default ModificarContabilidadComponent
</script>
<style scoped>
