  ...
  <div class="al-crear">
    ...
    <el-card class="box-card">
        <div slot="header" class="headercard">
            <span class="labelheadercard" >Aprobar Contabilidad</span>
        </div>
                            ...
                            <div class="col-md-12" >
                                <div class="row bodycard" style="background: white;margin-top: 0px;">
                                    <el-table
                                        ...
                                        <el-table-column
                                            prop="dtmPeriod" sortable  width="120"
                                            label="Fecha">
                                            <template scope="scope">
                                                <label v-bind:style="{width:'100%',margin: '0rem'}" >&nbsp;{{ getParseDate(scope.row.dtmPeriod) }}</label>
                                            </template>
                                        </el-table-column>   
                                        <el-table-column
...
<script>
import AprobarContabilidadComponent from '@/components/FI-FINANZAS/contabilidad-general/aprobar-contabilidad/aprobar-contabilidad.component'
export default AprobarContabilidadComponent
</script>
<style scoped>
