<template>
        ...
        <el-card class="box-card">
                    ...
                    <div class="row" style="margin-top: 3px;">
                        <div class="col-sm-9">
                            ...
                            <div  class="form-group row ">
                                ...
                                <div class="col-md-2 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input class="validador" size ="small" v-model="strVendor_NO" style="text-transform: capitalize" type="text" @keydown.native.enter="validad()">  
                                    </el-input>
                                    </div>
                                </div>
                            </div>  
            ...
            <br/>
             <el-tabs type="border-card">
                <el-tab-pane>
                    <span slot="label"><i class="el-icon-date"></i> Proveedores</span>                    
                    ...
                    <div class="col-md-12" >
                        ...
                        <el-table
                            ...
                            <el-table-column :render-header="filterstrVendor_NO"
                            prop="strVendor_NO" label="Proveedor" width="100" align="center">                                
                            </el-table-column>
                            <el-table-column  :render-header="filterstrVendor_Desc"
                             prop="strVendor_Desc" min-width="200" label="Descripcion">
                            </el-table-column>
                            <el-table-column :render-header="filterstrTax_ID"
                            prop="strTax_ID" label="RUC/DNI" width="90" >                                
                            </el-table-column>
                            <el-table-column :render-header="filterintIdCountry_ID"
                            prop="strCountry_Name" label="Pais" width="100" align="center">                                
                            </el-table-column>
                            <el-table-column :render-header="filterstrProvince"
                            prop="strProvince" label="Provincia" width="150" align="center">                                
                            </el-table-column>
                            <el-table-column :render-header="filterstrDistrict"
                            prop="strDistrict" label="Distrito" width="150" align="center">                                
                            </el-table-column>
                            <el-table-column :render-header="filterstrAddress"
                            prop="strAddress" label="Direccion" width="150" align="center">                                
                            </el-table-column>
    ...
    <b-modal ref="myModalRef" hide-footer title="Inactivar" size="sm"  v-model="dialogEliminar" @keydown.native.enter="btnEliminar">
      <div style="height:85px"> 
        ...
        <span style="font-size:13px">¿Desea Inactivar el Proveedor {{proveedor.strVendor_NO}}?</span>
      </div>
      <footer class="modal-footer">
    ...
    <b-modal ref="myModalRef" hide-footer title="Activar" size="sm"  v-model="dialogInactivar" @keydown.native.enter="btnInactivar">
      <div style="height:85px"> 
        <img src="../../../../images/tacho.png" style="width:14px; height:15px; cursor: pointer;font: 0px/100% Arial, Helvetica, sans-serif;margin-left: 0.3rem;"/>
        <span style="font-size:13px">¿Desea Activar el Proveedor {{proveedor.strVendor_NO}}?</span>
      </div>
      <footer class="modal-footer">
