    ...
    <div class="crear-ingreso-comprobante">
        ...
        <el-card class="box-card">
            <div slot="header" class="headercard">
                <span class="labelheadercard" > Modificar Elemento Gasto</span>
                    ...
                    <div class="row" style="margin-top: 3px;">
                        <div class="col-sm-9">
                            ...
                            <div  class="form-group row ">
                                ...
                                <div class="col-md-2 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input :disabled="visualizar" size ="small" v-model="cuentacontable.strAcc_Local_NO" type="text">  
                                    </el-input>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input :disabled="visualizar" size ="small" v-model="cuentacontable.strAcc_Local_Name" type="text">  
                                    </el-input>
                                    </div>
                                </div>
                            </div>                          
            ...
            <div class="row">
                <div class="col-sm-12" >
                    <el-tabs type="border-card"  style="margin-left: -10px;">
                        <el-tab-pane>
                            <span slot="label"><i class="el-icon-date"></i> Datos Control</span>
                            <el-card class="box-card">
                                <div class="row bodycard">
                                    <div class="container">
                                        <div class="row" style="margin-top: 3px;">
                                            <div class="col-sm-6" style="margin-top: 10px;">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-3 grupolabel">
                                                        <div class="input-group mb-3" >
                                                            <el-input :disabled="visualizar" size ="small" @blur="desactivar_Grupo" @focus="activar_Grupo" v-model="cuentacontable.strGrpAcctCont_Cod">                            
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-3 grupolabel">
                                                        <div class="input-group mb-3" >
                                                            <el-input :disabled="visualizar" size ="small" v-model="cuentacontable.strAcc_Type"  placeholder="">
                                                        </el-input>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-3 grupolabel">
                                                        <div class="input-group mb-3" >
                                                            <el-input :disabled="visualizar" size ="small" @blur="desactivar_Rubro" @focus="activar_Rubro" v-model="cuentacontable.strAcctItem_Cod">                            
                        ...
                        <el-tab-pane >
                            ...
                            <div class="col-md-9">
                                <div class="form-group row" >
                                    ...
                                    <div class="col-sm-1 grupolabel">
                                        <div class="input-group mb-3" >
                                            <el-input :disabled="visualizar" size ="small" @blur="desactivar_PlanCuentaCorporativo" @focus="activar_PlanCuentaCorporativo" v-model="cuentacontable.strChartAcct_C_Cod">                            
                        ...
                        <el-tab-pane >
                            <span slot="label"><i class="el-icon-document"></i> Permisos</span>
                            <div class="col-md-3">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4 grupolabel">
                                        <div class="input-group mb-3" >
                                            <el-checkbox :disabled="visualizar" class="col-sm-6" v-model="cuentacontable.blnAcc_DI"  >
                                                <span  style="font-size: 12px !important;color: #48576a;" >
                                                    Combustible
                                                </span>  
                                            </el-checkbox>
                                ...
                                <div class="form-group row" style="margin-top: -30px;">
                                    <div class="col-sm-5 grupolabel">
                                        <div class="input-group mb-3" >
                                            <el-checkbox :disabled="visualizar" class="col-sm-6" v-model="cuentacontable.blnAcc_cc"  >
                                                <span  style="font-size: 12px !important;color: #48576a;" >
                                                    Costos
                                                </span>  
                                            </el-checkbox>
                                ...
                                <div class="form-group row" style="margin-top: -30px;">
                                    <div class="col-sm-5 grupolabel">
                                        <div class="input-group mb-3" >
                                            <el-checkbox :disabled="visualizar" class="col-sm-6" v-model="cuentacontable.blnAcc_GL"  >
                                                <span  style="font-size: 12px !important;color: #48576a;" >
                                                    Contabilidad
                                                </span>  
                                            </el-checkbox>
                                    ...
                                    <div class="col-sm-4 grupolabel">
                                        <div class="input-group mb-3" >
                                            <el-checkbox :disabled="visualizar" class="col-sm-6"  v-model="cuentacontable.blnAcc_Destino" >
                                                <span  style="font-size: 12px !important;color: #48576a;" >
                                                    Destino
                                                </span>  
                                            </el-checkbox>
