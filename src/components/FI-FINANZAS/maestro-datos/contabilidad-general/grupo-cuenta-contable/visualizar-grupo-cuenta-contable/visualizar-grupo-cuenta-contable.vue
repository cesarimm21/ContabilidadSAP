<template>
    <div class="visualizar-grupo-cuenta-contable">
        ...
        <el-card class="box-card">
            <div slot="header" class="headercard">
                <span class="labelheadercard" > Visualizar Grupo Cuenta Contable</span>
...
<script>
import VisualizarGrupoCuentaContableComponent from '@/components/FI-FINANZAS/maestro-datos/contabilidad-general/grupo-cuenta-contable/visualizar-grupo-cuenta-contable/visualizar-grupo-cuenta-contable.component'
export default VisualizarGrupoCuentaContableComponent
</script>
<style scoped>
