<template>
    <div class="modificar-banco">
        ...
        <el-card class="box-card">
            <div slot="header" class="headercard">
                <span class="labelheadercard" > Modificar Banco</span>
                    ...
                    <div class="row" style="margin-top: 3px;">
                        <div class="col-sm-9">
                            ...
                            <div  class="form-group row ">
                                ...
                                <div class="col-md-2 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input class="validador" size ="small" v-model="strBank_Cod" style="text-transform: capitalize" type="text" @keydown.native.enter="validad()">  
                                    </el-input>
                                    </div>
                                </div>
                            </div>  
            ...
            <br/>
             <el-tabs type="border-card">
                <el-tab-pane>
                    <span slot="label"><i class="el-icon-date"></i> Bancos</span>                    
                    ...
                    <div class="col-md-12" >
                        ...
                        <el-table
                            ...
                            <el-table-column :render-header="filterstrBank_Cod"
                            prop="strBank_Cod" label="Banco" width="100" align="center">                                
                            </el-table-column>
                            <el-table-column  :render-header="filterstrBank_Name"
                             prop="strBank_Name" min-width="250" label="Descripcion">
                            </el-table-column>
                            <el-table-column prop="strCountry" :render-header="filterstrCountry"
                            width="100" label="Pais">
                            </el-table-column>
                            <el-table-column :render-header="filterstrBank_Curr"
                                prop="strBank_Curr" sortable width="150"
                                label="Moneda">
                            </el-table-column>
                            <el-table-column :render-header="filterstrBank_Type"
                                prop="strBank_Type" sortable width="50"
                                label="Tipo">
                            </el-table-column>
                            <el-table-column :render-header="filterstrBank_Account"
                                prop="strBank_Account" sortable width="120"
                                label="cta. Bancaria">
                            </el-table-column>
                            <el-table-column :render-header="filterdtmModified_Date"
                                prop="dtmModified_Date"   min-width="100"
                                label="Fecha">
    ...
    <b-modal ref="myModalRef" hide-footer title="Inactivar Banco" size="sm"  v-model="planDialog" @keydown.native.enter="inactivarPlan">
      <div style="height:85px">
        <img src="../../../../../../images/informacion.png" style="width:14px; height:15px; cursor: pointer;font: 0px/100% Arial, Helvetica, sans-serif;margin-left: 0.3rem;"/>
        <span style="font-size:13px">¿Desea Inactivar Banco {{documento.strBank_Cod}} ?</span>
      </div>
      <footer class="modal-footer">
    ...
    <b-modal ref="myModalRef" hide-footer title="Activar Banco" size="sm"  v-model="planActivarDialog" @keydown.native.enter="activarPlan">
      <div style="height:85px">
        <img src="../../../../../../images/informacion.png" style="width:14px; height:15px; cursor: pointer;font: 0px/100% Arial, Helvetica, sans-serif;margin-left: 0.3rem;"/>
        <span style="font-size:13px">¿Desea Activar Banco {{documento.strBank_Cod}} ?</span>
      </div>
      <footer class="modal-footer">
...
<script>
import VisualizarModificarBancoComponent from '@/components/FI-FINANZAS/maestro-datos/tesoreria/bancos/visualizar-modificar-banco/visualizar-modificar-banco.component'
export default VisualizarModificarBancoComponent
</script>
<style scoped>
