...
<script>
import ModificarClienteComponent from '@/components/FI-FINANZAS/maestro-datos/cuentas-cobrar/edit-cliente/edit-cliente.component'
export default ModificarClienteComponent
</script>
<style scoped>
</style>