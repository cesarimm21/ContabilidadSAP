                    ...
                    <div class="col-sm-12" >
                        <el-card class="box-card" style="margin-left: -10px;">
                            <div slot="header" class="headercard" style="margin-top: -4px;">
                                <buttons-accions  v-on:validarView="EditarCliente()" v-on:Limpiar="Limpiar" v-on:Buscar="Buscar" v-on:siguiente="siguiente()" v-on:anterior="anterior()" v-on:EliminarItem="EliminarItem()"></buttons-accions>
                            </div>
...
<script>
import VisualizarClienteComponent from '@/components/FI-FINANZAS/maestro-datos/cuentas-cobrar/view-cliente/view-cliente.component'
export default VisualizarClienteComponent
</script>
<style scoped>
</style>