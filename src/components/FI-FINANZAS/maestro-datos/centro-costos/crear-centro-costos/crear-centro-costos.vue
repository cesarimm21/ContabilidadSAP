    ...
    <div class="crear-ingreso-comprobante">
        ...
        <el-card class="box-card">
            <div slot="header" class="headercard">
                <span class="labelheadercard" > Crear centro costos</span>
                    ...
                    <div class="row" style="margin-top: 3px;">
                        <div class="col-sm-9">
                            ...
                            <div  class="form-group row ">
                                ...
                                <div class="col-md-2 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input size ="small"  v-model="centrocosto.strCostCenter_NO" type="text">  
                                    </el-input>
                                    </div>
                                </div>
                                            ...
                                            <div class="col-sm-8" style="margin-top: 10px;">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-2 grupolabel">
                                                        <div class="input-group mb-3" >
                                                        <el-input   size ="small" style="font-size:11px;" v-model="centrocosto.strCostCenter_Name"></el-input>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-2 grupolabel">
                                                        <div class="input-group mb-3" >
                                                        <el-input size ="small" @blur="desactivar_GrupoProceso" @focus="activar_GrupoProceso" v-model="centrocosto.strCCGrpProc_Cod">                            
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-2 grupolabel">
                                                        <div class="input-group mb-3" >
                                                            <el-input size ="small" @blur="desactivar_CuentaContableDebe" @focus="activar_CuentaContableDebe" v-model="centrocosto.strCodAcctDest_Debit"  placeholder="">
                                                    ...
                                                    <div class="col-sm-2 grupolabel">
                                                        <div class="input-group mb-3" >
                                                        <el-input size ="small" @blur="desactivar_CuentaContableHaber" @focus="activar_CuentaContableHaber" v-model="centrocosto.strAcctDest_Credit"  placeholder="">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-2 grupolabel">
                                                        <div class="input-group mb-3" >
                                                        <el-input size ="small" @blur="desactivar_CategoriaCentroCosto" @focus="activar_CategoriaCentroCosto" v-model="centrocosto.strCCCategory_Cod"  placeholder="">
                                                    ...
                                                    <div class="col-sm-2 grupolabel">
                                                        <div class="input-group mb-3" >
                                                        <el-input size ="small" @blur="desactivar_CentroCosto" @focus="activar_CentroCosto" v-model="centrocosto.strCostCen_Father_NO"  placeholder="">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-2 grupolabel">
                                                        <div class="input-group mb-3" >
                                                        <el-input size ="small" @blur="desactivar_GrupoArea" @focus="activar_GrupoArea" v-model="centrocosto.strCCGrpArea_Cod"  placeholder="">
        ...
        <el-dialog title="Grupo Proceso"  :visible.sync="dialogGrupoProceso" @close="closeDialogGrupoProceso" size="small" >
            <bgrupoproceso v-on:grupoprocesoseleccionado="grupoprocesoseleccionado($event)" v-on:grupoprocesoClose="closeDialogGrupoProceso()">
            </bgrupoproceso>
        </el-dialog> 
...
import CrearCentroCostosComponent from '@/components/FI-FINANZAS/maestro-datos/centro-costos/crear-centro-costos/crear-centro-costos.component'
export default CrearCentroCostosComponent
</script>
<style scoped>
