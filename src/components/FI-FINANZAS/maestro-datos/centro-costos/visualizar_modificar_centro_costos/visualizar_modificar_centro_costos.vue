<template>
    ...
    <b-modal ref="myModalRef" hide-footer title="Inactivar Centro Costos" size="sm"  v-model="planDialog" @keydown.native.enter="inactivarPlan">
      <div style="height:85px">
        <img src="../../../../../images/informacion.png" style="width:14px; height:15px; cursor: pointer;font: 0px/100% Arial, Helvetica, sans-serif;margin-left: 0.3rem;"/>
        <span style="font-size:13px">¿Desea Inactivar Centro Costo {{documento.strCostCenter_NO}} ?</span>
      </div>
      <footer class="modal-footer">
    ...
    <b-modal ref="myModalRef" hide-footer title="Activar Centro Costos" size="sm"  v-model="planActivarDialog" @keydown.native.enter="activarPlan">
      <div style="height:85px">
        <img src="../../../../../images/informacion.png" style="width:14px; height:15px; cursor: pointer;font: 0px/100% Arial, Helvetica, sans-serif;margin-left: 0.3rem;"/>
        <span style="font-size:13px">¿Desea Activar Centro Costos {{documento.strCostCenter_NO}} ?</span>
      </div>
      <footer class="modal-footer">
...
<script>
import VisualizarModificarCentroCostosComponent from '@/components/FI-FINANZAS/maestro-datos/centro-costos/visualizar_modificar_centro_costos/visualizar_modificar_centro_costos.component'
export default VisualizarModificarCentroCostosComponent
</script>
<style scoped>
