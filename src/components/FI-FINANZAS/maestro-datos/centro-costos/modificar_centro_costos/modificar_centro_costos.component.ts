...
export default class ModificarCentroCostosComponent extends Vue {
  ...
  load(){
    ...
    this.cargar(object.strCostCenter_NO);
  }
  cargar(code){
    centrocostosService.GetCentroCostosID(code)
    .then(res=>{
      if(res!=undefined){
        console.log('cargarData1',res)
        this.centrocosto=res[0]
        this.strlevel=this.centrocosto.strlevel;
        this.dtmStart_Date==this.centrocosto.dtmStart_Date;
        this.dtmEnd_Date==this.centrocosto.dtmEnd_Date;
        this.centrocosto.strCCGrpProc_Cod=this.centrocosto.intIdProccGrp_ID.strCCGrpProc_Cod;
        this.centrocosto.strCCCategory_Cod=this.centrocosto.intIdCCCategory_ID.strCCCategory_Cod;
        this.centrocosto.strCCGrpArea_Cod=this.centrocosto.intIdCCGrpArea_ID.strCCGrpArea_Cod;
        // this.centrocosto.strGrpAcctCont_Cod=res[0].intIdGrpCta_ID.strGrpAcctCont_Cod;
        // this.centrocosto.strExpGroup_Cod=res[0].intIdExpGroup_ID.strExpGroup_Cod;
        // this.centrocosto.strWH_Cod=res[0].intIdWH_ID.strWH_Cod;
        // this.centrocosto.strAcctItem_Cod=res[0].intIdAcctItem_ID.strAcctItem_Cod;
        console.log('cargarData2',this.centrocosto)
      }
    })
    .catch(error=>{
  ...
  categoriacentrocostoseleccionado(val,dialog:boolean){
    ...
    this.centrocosto.intIdCCCategory_ID=val.intIdCCCategory_ID;
    this.dialogCategoriaCentroCosto=false;  
  }
  ...
  guardarTodo(){
    ...
    centrocostosService.UpdateCentroCostosID(this.centrocosto)
    .then(response=>{
      this.issave=true;
