...
//#endregion
  ...
  SaveFactura(event){
    ...
    else
    {
      ...
      this.factura.strDoc_Status="egaona";
      this.factura.strCreation_User=this.factura.strDoc_Status;
      // var datetime=this.factura.dtmPeriod;      
      ...
      for(let i=0;i<this.multipleSelection.length;i++){
        ...
        itemDG.strContable_Cod=this.multipleSelection[i].strAccount_Cod;
        itemDG.dtmPosting_Date=new Date();
        var datetime=this.factura.dtmPeriod;
        itemDG.strPeriod_NO=periodo;
        itemDG.strYear=anio;
        itemDG.dtmProcess_Date=this.factura.dtmDoc_Acc_Date;
        itemDG.strStatus_Account='B';        
        ...
        itemDG.fltSalida_Cant=this.multipleSelection[i].intQuantity;
        ...
        itemDG.fltImporte_Local=this.multipleSelection[i].fltValue_Local;
        itemDG.fltImporte_USD=parseFloat(dat1);
        ...
        itemDG_40.fltImporte_Local=this.factura.fltValue_Tax_Local;
        itemDG_40.fltImporte_USD=this.factura.fltValue_Tax_Corp;
        ...
        itemDG_42.fltImporte_Local=-this.factura.fltOperation_NoTax_Local;
        itemDG_42.fltImporte_USD=-this.factura.fltOperation_NoTax_Corp;
      ...
      let loadingInstance = Loading.service({
        ...
        .then(response=>{
          ...
          for(var i=0;i<this.diarioInput.length;i++){
            this.diarioInput[i].strVoucher_NO=response;
