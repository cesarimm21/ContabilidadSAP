  ...
  <div class="modificar-pr">
                ...
                <div class="row" style="margin-top: 3px;">
                    ...
                    <div class="col-sm-9" >
                        <div class="form-group row ">
                            ...
                            <div class="col-md-2 grupolabel">
                                <div class="input-group mb-3" >
                                <el-input :disabled="true" size ="small" v-model="requisicionModel.strCompany_Cod"  placeholder="">
                                </el-input>
                                </div>
                            </div>
   ...
   <!--DIALOG BUSQUEDA CENTRO COSTOS-->
    ...
    <el-dialog title="Busqueda moneda"  :visible.sync="dialogMoneda" @close="closeMoneda" size="small" >
      <bmoneda v-on:monedaselecionado="SeleccionadoMoneda($event)" v-on:closeMoneda="closeMoneda()">
      </bmoneda>
    </el-dialog>
    ...
    <el-dialog title="Busqueda material"  :visible.sync="dialogMaterial" @close="materialClose" size="small" >
