                                ...
                                <div class="row bodycard" style="background: white;margin-top: 0px;">
                                      <el-table
                                        ...
                                        <el-table-column :render-header="filterstrDesc_Header"
                                            ...
                                            label="Descripcion">
                                            <template scope="scope">
                                                <label v-bind:style="{width:'100%',margin: '0rem'}" @click="clickmaterialdescripcion(scope.row,scope.row.edit,scope.column.property)">&nbsp;{{ scope.row.strDesc_Header }}</label>
                                            </template>
                                        </el-table-column>
                                        <el-table-column :render-header="filterdtmRequested_Date"
                                            ...
                                            <template scope="scope">
                                                <el-date-picker
                                                    v-bind:style="{width:'100%',margin: '0rem'}"
                                                    type="date"
                                                    format="dd.MM.yyyy"
