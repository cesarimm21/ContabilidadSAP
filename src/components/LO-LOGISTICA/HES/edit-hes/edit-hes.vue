<template>
  <div class="crear-hes">
      <ol  style="margin-left: -1.5rem;background: linear-gradient(rgb(229, 241, 247) 0%, rgb(255, 255, 255) 100%);    margin-bottom: 0rem !important;">
        <quickaccessmenu v-on:guardarEditHES="guardarEditHES($event)" v-on:backPage="backPage($event)"  v-on:reloadpage="reloadpage($event)"></quickaccessmenu>
        </ol>
      <el-card class="box-card">
          
            <div slot="header" class="headercard">
                <span class="labelheadercard" > Editar aceptación servicio</span>
            </div>
                                ...
                                <div class="row" style="margin-top: 3px;">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group row" style="margin-top:10px;">
                                            ...
                                            <div class="col-sm-3 grupolabel">
                                                <div class="input-group mb-3" >
                                                <el-input type="date"  size ="small" style="font-size:11px;" @change="dateuntil" v-model="fecha_until"></el-input>
                                                </div>
                                            </div>                                            
                                        </div>
                                    </div>
    ...
    <el-dialog title="Busqueda Aceptación servicio"  :visible.sync="dialogHES" size="small" >
            <div>
                ...
                <el-table
                    ...
                    <el-table-column  prop="strHES_NO" label="Codigo" width="180">
                    </el-table-column>  
...
<script>
import EditHesComponent from '@/components/LO-LOGISTICA/HES/edit-hes/edit-hes.component'
export default EditHesComponent
</script>
<style scoped> 
