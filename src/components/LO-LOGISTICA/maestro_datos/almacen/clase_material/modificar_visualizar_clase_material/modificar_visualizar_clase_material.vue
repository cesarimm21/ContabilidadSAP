  ...
  <div class="al-crear">
    ...
    <b-modal ref="myModalRef" hide-footer title="Activar" size="sm"  v-model="dialogInactivar" @keydown.native.enter="btnInactivar">
      <div style="height:85px"> 
        ...
        <span style="font-size:13px">¿Desea Activar Clase Material {{item}}?</span>
      </div>
      <footer class="modal-footer">
...
<script>
import VisualizarModificarClaseMaterialComponent from '@/components/LO-LOGISTICA/maestro_datos/almacen/clase_material/modificar_visualizar_clase_material/modificar_visualizar_clase_material.component'
export default VisualizarModificarClaseMaterialComponent
</script>
<style scoped>
