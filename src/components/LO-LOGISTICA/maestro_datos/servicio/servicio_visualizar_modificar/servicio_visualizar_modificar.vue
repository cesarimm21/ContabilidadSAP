<template>
    <div class="modificar-servicio">
        ...
        <el-card class="box-card">
            <div slot="header" class="headercard">
                <span class="labelheadercard" > Modificar Servicio</span>
                ...
                <div class="container">
                    <div class="row" style="margin-top: 3px;">
                        <div class="col-sm-9">
                            ...
                            <div  class="form-group row ">
                                <label class="el-form-item__label col-md-2" >Servicio</label>
                                <div class="col-md-2 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input :autofocus="true" class="validador" size ="small" v-model="strStock_Cod" style="text-transform: capitalize" type="text" @keydown.native.enter="validad()">  
                                    </el-input>
                                    </div>
                                </div>
                            </div>  
            ...
            <br/>
             <el-tabs type="border-card">
                <el-tab-pane>
                    <span slot="label"><i class="el-icon-date"></i> Servicios</span>                    
                    ...
                    <div class="col-md-12" >
                        ...
                        <el-table
                                        ...
                                        prop="strStock_Cod" width="100" label="Material">
    ...
    <b-modal ref="myModalRef" hide-footer title="Inactivar Servicio" size="sm"  v-model="planDialog" @keydown.native.enter="inactivarPlan">
      <div style="height:85px">
        <img src="../../../../../images/informacion.png" style="width:14px; height:15px; cursor: pointer;font: 0px/100% Arial, Helvetica, sans-serif;margin-left: 0.3rem;"/>
        <span style="font-size:13px">¿Desea Inactivar Servicio {{documento.strDoc_Trans_Cod}} ?</span>
      </div>
      <footer class="modal-footer">
    ...
    <b-modal ref="myModalRef" hide-footer title="Activar Servicio" size="sm"  v-model="planActivarDialog" @keydown.native.enter="activarPlan">
      <div style="height:85px">
        <img src="../../../../../images/informacion.png" style="width:14px; height:15px; cursor: pointer;font: 0px/100% Arial, Helvetica, sans-serif;margin-left: 0.3rem;"/>
        <span style="font-size:13px">¿Desea Activar Servicio {{documento.strDoc_Trans_Cod}} ?</span>
      </div>
      <footer class="modal-footer">
...
import VisualizarModificarServicioComponent from '@/components/LO-LOGISTICA/maestro_datos/servicio/servicio_visualizar_modificar/servicio_visualizar_modificar.component'
export default VisualizarModificarServicioComponent
</script>
<style scoped>
