    ...
    <div class="visualizar-servicio">
        ...
        <el-card class="box-card">
            <div slot="header" class="headercard">
                <span class="labelheadercard" > Visualizar Servicio</span>
...
<script>
import VisualizarServicioMateComponent from '@/components/LO-LOGISTICA/maestro_datos/servicio/servicio_visualizar/servicio_visualizar.component'
export default VisualizarServicioMateComponent
</script>
<style scoped>
