    ...
    <div class="crear-ingreso-comprobante">
        ...
        <el-card class="box-card">
            <div slot="header" class="headercard">
                <span class="labelheadercard" > Crear Clase Servicio</span>
                    ...
                    <div class="row" style="margin-top: 3px;">
                        <div class="col-sm-9">
                            ...
                            <div  class="form-group row ">
                                ...
                                <div class="col-md-2 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input size ="small"  v-model="clasematerial.strMatClass_Cod" type="text">  
                                    </el-input>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div  class="form-group row ">
                                ...
                                <div class="col-md-2 grupolabel">
                                    <div class="input-group mb-3" >
                                        <el-select  v-model="tiporequisicion" style="font-size:13px"  allow-create clearable placeholder="" size="mini" filterable disabled>
...
import CrearClaseServicioComponent from '@/components/LO-LOGISTICA/maestro_datos/servicio/clase_servicio/crear_clase_servicio/crear_clase_servicio.component'
export default CrearClaseServicioComponent
</script>
<style scoped>
