...
<script>
import ModificarServicioMateComponent from '@/components/LO-LOGISTICA/maestro_datos/servicio/servicio_modificar/servicio_modificar.component'
export default ModificarServicioMateComponent
</script>
<style scoped>
