    ...
    <div class="docidentidad">
        ...
        <el-card class="box-card">
            <div slot="header" class="headercard">
                <span class="labelheadercard" > Visualizar Grupo Area</span>
            ...
            <br/>
             <el-tabs type="border-card">
                <el-tab-pane>
                    <span slot="label"><i class="el-icon-date"></i>Visualizar Grupo Area</span>                    
...
<script>
import VisualizarGrupoAreaComponent from '@/components/CP-PRESUPUESTO/maestro_datos/grupo-area/visualizar_grupoarea.component'
export default VisualizarGrupoAreaComponent
</script>
<style scoped>
