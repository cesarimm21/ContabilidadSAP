                    ...
                    <div class="row" style="margin-top: 3px;">
                        <div class="col-sm-9">
                           ...
                           <div  class="form-group row ">
                                ...
                                <div class="col-md-2 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input class="validador" size ="small" v-model="documento.strCCGrpArea_Cod" style="text-transform: capitalize" type="text" :maxlength="2" disabled>  
                                    </el-input>
                                    </div>
                                </div>
                            </div>    
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4 grupolabel">
                                    <div class="input-group mb-3" >
                                        <el-input class="validador" size="small" v-model="documento.strCCGrpArea_Desc"  :disabled="enabledtf" :autofocus="true">
                                        </el-input>
                                    </div>
                                </div>
                            </div>
...
import ViewAndEditGrupoAreaComponent from '@/components/CP-PRESUPUESTO/maestro_datos/grupo-area/viewandedit_grupoarea.component'
export default ViewAndEditGrupoAreaComponent
</script>
<style scoped>
   .sinLinea{
