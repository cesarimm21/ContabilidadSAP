<template>
    <div class="crear-ingreso-comprobante">
        ...
        <el-card class="box-card">
            <div slot="header" class="headercard">
                <span class="labelheadercard" >Visualizar Tipo Requisicion</span>
                    ...
                    <div class="row" style="margin-top: 3px;">
                        <div class="col-sm-9">
                            ...
                            <div  class="form-group row ">
                                ...
                                <div class="col-md-2 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input class="validador" size ="small" v-model="strTypeReq_Cod" style="text-transform: capitalize" type="text" @keydown.native.enter="validad()">  
                                    </el-input>
                                    </div>
                                </div>
                            </div>  
            ...
            <br/>
             <el-tabs type="border-card">
                <el-tab-pane>
                    <span slot="label"><i class="el-icon-date"></i>Tipos Requisiciones</span>                    
                    ...
                    <div class="col-md-12" >
                        ...
                        <el-table
                            ...
                            <el-table-column :render-header="filterstrTypeReq_Cod"
                            prop="strTypeReq_Cod" label="Tipo Requisicion" width="120" align="center">                                
                            </el-table-column>
                            <el-table-column  :render-header="filterstrTipReq_Desc"
                             prop="strTipReq_Desc" min-width="200" label="Descripcion">
                            </el-table-column>
    ...
    <b-modal ref="myModalRef" hide-footer title="Eliminar" size="sm"  v-model="dialogEliminar" @keydown.native.enter="btnEliminar">
      <div style="height:85px"> 
        ...
        <span style="font-size:13px">¿Desea Eliminar el Tipo Requisicion {{tipoRequi.strTypeReq_Cod}}?</span>
      </div>
      <footer class="modal-footer">
    ...
    <b-modal ref="myModalRef" hide-footer title="Inactivar" size="sm"  v-model="dialogInactivar" @keydown.native.enter="btnInactivar">
      <div style="height:85px"> 
        <img src="../../../../images/tacho.png" style="width:14px; height:15px; cursor: pointer;font: 0px/100% Arial, Helvetica, sans-serif;margin-left: 0.3rem;"/>
        <span style="font-size:13px">¿Desea Inactivar el Tipo Requisicion {{tipoRequi.strTypeReq_Cod}}?</span>
      </div>
      <footer class="modal-footer">
...
import VisualizarTipoRequisicionComponent from '@/components/XX-CONFI/logistica/tipo_requisicion/visualizar_tipo_requi.component'
export default VisualizarTipoRequisicionComponent
</script>
<style scoped>
