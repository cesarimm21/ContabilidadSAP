    ...
    <div class="crear-ingreso-comprobante">
        ...
        <el-card class="box-card">
            <div slot="header" class="headercard">
                <span class="labelheadercard" > Modificar Tipo Requisicion</span>
...
import ModificarTipoRequisicionComponent from '@/components/XX-CONFI/logistica/tipo_requisicion/modificar_tipo_requi.component'
export default ModificarTipoRequisicionComponent
</script>
<style scoped>
