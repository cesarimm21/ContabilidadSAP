<template>
    <div class="crear-ingreso-comprobante">
        ...
        <el-card class="box-card">
            <div slot="header" class="headercard">
                <span class="labelheadercard" > Modificar Metodo Valuacion</span>
            ...
            <br/>
             <el-tabs type="border-card">
                <el-tab-pane>
                    ...
                    <buttons-accions v-on:validarView="validarView()" v-on:Limpiar="Limpiar" v-on:Print="Print" v-on:Buscar="Buscar" v-on:AscItem="AscItem" v-on:DscItem="DscItem" v-on:EliminarItem="EliminarItem()" v-on:siguiente="siguiente()" v-on:anterior="anterior()" v-on:ActivarDesactivar="ActivaDesactivar()"></buttons-accions>
                    <div class="col-md-12" >
    ...
    <b-modal ref="myModalRef" hide-footer title="Eliminar Servicio Prestado ND" size="sm"  v-model="servicioDialog" @keydown.native.enter="deleteServicio">
      <div style="height:85px">
        <img src="../../../../images/informacion.png" style="width:14px; height:15px; cursor: pointer;font: 0px/100% Arial, Helvetica, sans-serif;margin-left: 0.3rem;"/>
        <span style="font-size:13px">¿Desea eliminar la servicio prestado {{documento.strValMeth_Cod}} ?</span>
      </div>
      <footer class="modal-footer">
...
import ModificarMetodoEvaComponent from '@/components/XX-CONFI/logistica/metodo_eva/modificar_metodo_eva.component'
export default ModificarMetodoEvaComponent
</script>
<style scoped>
