    ...
    <div class="crear-ingreso-comprobante">
        ...
        <el-card class="box-card">
            <div slot="header" class="headercard">
                <span class="labelheadercard" > Crear Metodo de Valuacion</span>
                    ...
                    <div class="row" style="margin-top: 3px;">
                        <div class="col-sm-9">
                            ...
                            <div  class="form-group row ">
                                ...
                                <div class="col-md-2 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input class="validador" size ="small" v-model="metodo.strValMeth_Cod" style="text-transform: capitalize" type="text" >  
                                    </el-input>
                                    </div>
                                </div>
                            </div>    
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6 grupolabel">
                                    <div class="input-group mb-6" >
                                        <el-input  class="validador" size="small" v-model="metodo.strValMeth_Desc"  >
                                        </el-input>
                                    </div>
                                </div>
                            </div>
...
import CrearMetodoEvaComponent from '@/components/XX-CONFI/logistica/metodo_eva/crear_metodo_eva.component'
export default CrearMetodoEvaComponent
</script>
<style scoped>
.sinLinea{
