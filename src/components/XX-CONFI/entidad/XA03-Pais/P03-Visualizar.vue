    ...
    <div class="crear-ingreso-comprobante">
        ...
        <el-card class="box-card">
            <div slot="header" class="headercard">
                <span class="labelheadercard" > Visualizar Pais</span>
                    ...
                    <div class="row" style="margin-top: 3px;">
                        <div class="col-sm-9">
                            ...
                            <div  class="form-group row ">
                                ...
                                <div class="col-md-2 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input class="validador" size ="small" v-model="pais.strCountry_Cod" style="text-transform: capitalize" type="text">  
                                    </el-input>
                                    </div>
                                </div>
                            </div>  
...
import VisualizarPaisComponent from '@/components/XX-CONFI/entidad/XA03-Pais/P03-Visualizar.component'
export default VisualizarPaisComponent
</script>
<style scoped>
