...
<script>
import ModificarCorrelativoComponent from '@/components/XX-CONFI/maestro_datos/correlativo/modif_correlativo/modif_correlativo.component'
export default ModificarCorrelativoComponent
</script>
<style scoped>
