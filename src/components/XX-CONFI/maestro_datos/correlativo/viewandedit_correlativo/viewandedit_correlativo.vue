                            ...
                            <div class="col-md-12" >
                                <div class="row bodycard" style="background: white;margin-top: 0px;">
                                    <el-table
                                        ...
                                        <el-table-column  sortable prop="strCorrel_Cod" width="100" label="Codigo Modulo">
                                            <template scope="scope">
                                            <label v-bind:style="{width:'100%',margin: '0rem'}" >&nbsp;{{ scope.row.strCorrel_Cod }}</label>
                                            </template>
                                        </el-table-column> 
                                        <el-table-column
                                            prop="strProccess_Name" sortable  
                                        ...
                                        <el-table-column
                                            prop="strTransaction_Name" sortable  
                                            label="Transaccion">
                                            <template scope="scope">
...
import ViewAndEditCorrelativoComponent from '@/components/XX-CONFI/maestro_datos/correlativo/viewandedit_correlativo/viewandedit_correlativo.component'
export default ViewAndEditCorrelativoComponent
</script>
