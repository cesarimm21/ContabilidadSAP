                        ...
                        <div class="col-sm-9">
                            ...
                            <div  class="form-group row ">
                                ...
                                <div class="col-md-6 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input :disabled='visualizar' class="validador" size ="small" v-model="componente.strComp_Cod"  type="text">  
                                    </el-input>
                                    </div>
                                </div>
                            </div>    
                            <div  class="form-group row ">
                                ...
                                <div class="col-md-2 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input :disabled='visualizar' class="validador" size ="small" v-model="componente.strComp_Desc"  type="text">  
                                    </el-input>
                                    </div>
                                </div>
                            </div>            
...
import ModificarComponenteCuentasComponent from '@/components/XX-CONFI/maestro_datos/componente_cuentas/modif_componente_cuentas/modif_componente_cuentas.component'
export default ModificarComponenteCuentasComponent
</script>
<style scoped>
