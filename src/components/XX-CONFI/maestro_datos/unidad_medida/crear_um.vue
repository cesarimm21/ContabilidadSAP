    ...
    <div class="crear-ingreso-comprobante">
        ...
        <el-card class="box-card">
            <div slot="header" class="headercard">
                <span class="labelheadercard" > Crear Unidad de Medida</span>
                        ...
                        <div class="col-sm-9">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6 grupolabel">
                                    <div class="input-group mb-3" >
                                        <el-input class="validador" size="small" v-model="unidad.strUM_Desc"  >
                                        </el-input>
                                    </div>
                                </div>
                            </div>      
...
import CrearUMComponent from '@/components/XX-CONFI/maestro_datos/unidad_medida/crear_um.component'
export default CrearUMComponent
</script>
<style scoped>
