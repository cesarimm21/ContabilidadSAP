<template>
    <div class="modificar-servicioprestado">
        ...
        <el-card class="box-card">
            <div slot="header" class="headercard">
                <span class="labelheadercard" > Modificar Grupo Comprador</span>
    ...
    <b-modal ref="myModalRef" hide-footer title="Inactivar Grupo Comprador" size="sm"  v-model="planDialog" @keydown.native.enter="inactivarPlan">
      <div style="height:85px">
        <img src="../../../../../images/informacion.png" style="width:14px; height:15px; cursor: pointer;font: 0px/100% Arial, Helvetica, sans-serif;margin-left: 0.3rem;"/>
        <span style="font-size:13px">¿Desea Inactivar Grupo Comprador {{documento.strNDServ_Cod}} ?</span>
      </div>
      <footer class="modal-footer">
    ...
    <b-modal ref="myModalRef" hide-footer title="Activar Grupo Comprador" size="sm"  v-model="planActivarDialog" @keydown.native.enter="activarPlan">
      <div style="height:85px">
        <img src="../../../../../images/informacion.png" style="width:14px; height:15px; cursor: pointer;font: 0px/100% Arial, Helvetica, sans-serif;margin-left: 0.3rem;"/>
        <span style="font-size:13px">¿Desea Activar Grupo Comprador {{documento.strNDServ_Cod}} ?</span>
      </div>
      <footer class="modal-footer">
...
<script>
import ViewAndEditGrupoCompradorComponent from '@/components/XX-CONFI/maestro_datos/grupo_comprador/viewandedit_grupo_comprador/viewandedit_grupo_comprador.component'
export default ViewAndEditGrupoCompradorComponent
</script>
<style scoped>
