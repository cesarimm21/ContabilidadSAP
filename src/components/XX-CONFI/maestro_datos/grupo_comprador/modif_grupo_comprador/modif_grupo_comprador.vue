                    ...
                    <div class="row" style="margin-top: 3px;">
                        <div class="col-sm-9">
                            ...
                            <div  class="form-group row ">
                                ...
                                <div class="col-md-2 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input :disabled="true" class="validador" size ="small" v-model="grupocomprador.strGrpPurch_Cod"  type="text">  
                                    </el-input>
                                    </div>
                                </div>
                            </div>    
...
import ModificarGrupoCompradorComponent from '@/components/XX-CONFI/maestro_datos/grupo_comprador/modif_grupo_comprador/modif_grupo_comprador.component'
export default ModificarGrupoCompradorComponent
</script>
<style scoped>
