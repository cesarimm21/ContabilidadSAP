    ...
    <div class="crear-ingreso-comprobante">
        ...
        <el-card class="box-card">
            <div slot="header" class="headercard">
                <span class="labelheadercard" > Crear Grupo Comprador</span>
                    ...
                    <div class="row" style="margin-top: 3px;">
                        <div class="col-sm-9">
                            ...
                            <div  class="form-group row ">
                                ...
                                <div class="col-md-2 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input class="validador" size ="small" v-model="grupocomprador.strGrpPurch_Cod"  type="text">  
                                    </el-input>
                                    </div>
                                </div>
                            </div>    
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6 grupolabel">
                                    <div class="input-group mb-3" >
                                        <el-input class="validador" size="small" v-model="grupocomprador.strGrpPurch_Desc"  >
                                        </el-input>
                                    </div>
                                </div>
                            </div>           
...
import CrearGrupoCompradorComponent from '@/components/XX-CONFI/maestro_datos/grupo_comprador/crear_grupo_comprador/crear_grupo_comprador.component'
export default CrearGrupoCompradorComponent
</script>
<style scoped>
