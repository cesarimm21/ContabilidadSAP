    ...
    <div class="crear-ingreso-comprobante">
        ...
        <el-card class="box-card">
            <div slot="header" class="headercard">
                <span class="labelheadercard" > Modificar Plan Contable Local</span>
...
import ModificarPlanLocalComponent from '@/components/XX-CONFI/maestro_datos/plan_con_local/modificar_planlocal.component'
export default ModificarPlanLocalComponent
</script>
<style scoped>
