  ...
  <div class="al-crear">
    ...
    <el-card class="box-card">
        <div slot="header" class="headercard">
            <span class="labelheadercard" >Modificar Rubro</span>
        </div>
           ...
           <div class="container">
                <div class="row" style="margin-top: 3px;">
                    <div class="col-sm-9" >
                        ...
                        <div class="form-group row ">
                            <label class="el-form-item__label col-md-2" >Rubro</label>
                            <div class="col-md-2 grupolabel">
                                <div class="input-group mb-3" >
                            ...
                            <div class="col-md-12" >
                                <div class="row bodycard" style="background: white;margin-top: 0px;">
                                    <el-table
                                        ...
                                        <el-table-column  sortable prop="strAcctItem_Cod" width="100" label="Rubro">
                                            <template scope="scope">
                                            <label v-bind:style="{width:'100%',margin: '0rem'}" >&nbsp;{{ scope.row.strAcctItem_Cod }}</label>
                                            </template>
                                        </el-table-column> 
                                        <el-table-column
                                            prop="strAcctItem_Desc" sortable  
                                            label="Descripcion">
                                            <template scope="scope">
                                                <label v-bind:style="{width:'100%',margin: '0rem'}" >&nbsp;{{ scope.row.strAcctItem_Desc }}</label>
                                            </template>
                                        </el-table-column>
                                        <el-table-column
                                            prop="strAcctItem_Pos" sortable  
                                            label="Posicion">
                                            <template scope="scope">
                                                <label v-bind:style="{width:'100%',margin: '0rem'}" >&nbsp;{{ scope.row.strAcctItem_Pos }}</label>
                                            </template>
                                        </el-table-column>
...
import ViewAndEditRubroCuentaComponent from '@/components/XX-CONFI/maestro_datos/rubro_cuenta/viewandedit_rubro_cuenta/viewandedit_rubro_cuenta.component'
export default ViewAndEditRubroCuentaComponent
</script>
