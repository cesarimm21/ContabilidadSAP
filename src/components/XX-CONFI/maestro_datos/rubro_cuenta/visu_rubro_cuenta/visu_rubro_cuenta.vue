  ...
  <div class="al-crear">
    ...
    <el-card class="box-card">
        <div slot="header" class="headercard">
            <span class="labelheadercard" >Visualizar Rubro</span>
        </div>
...
import VisuRubroCuentaComponent from '@/components/XX-CONFI/maestro_datos/rubro_cuenta/visu_rubro_cuenta/visu_rubro_cuenta.component'
export default VisuRubroCuentaComponent
</script>
