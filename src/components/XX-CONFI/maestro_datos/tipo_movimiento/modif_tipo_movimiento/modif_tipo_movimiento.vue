                    ...
                    <div class="row" style="margin-top: 3px;">
                        <div class="col-sm-9">
                            ...
                            <div  class="form-group row ">
                                ...
                                <div class="col-md-2 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input class="validador" :disabled="true" size ="small" v-model="tipomovimiento.strTypeMov_Cod"  type="text">  
                                    </el-input>
                                    </div>
                                </div>
                            </div>    
...
import ModificarTipoMovimientoComponent from '@/components/XX-CONFI/maestro_datos/tipo_movimiento/modif_tipo_movimiento/modif_tipo_movimiento.component'
export default ModificarTipoMovimientoComponent
</script>
<style scoped>
