<template>
    <div class="modificar-tipomovimiento">
        ...
        <el-card class="box-card">
            <div slot="header" class="headercard">
                <span class="labelheadercard" > Modificar Tipo Movimiento</span>
                    ...
                    <div class="row" style="margin-top: 3px;">
                        <div class="col-sm-9">
                            ...
                            <div  class="form-group row ">
                                ...
                                <div class="col-md-2 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input class="validador" size ="small" v-model="strTypeMov_Cod" style="text-transform: capitalize" type="text" @keydown.native.enter="validad()">  
                                    </el-input>
                                    </div>
                                </div>
                            </div>  
            ...
            <br/>
             <el-tabs type="border-card">
                <el-tab-pane>
                    <span slot="label"><i class="el-icon-date"></i> Tipo Movimientoes</span>                    
                    ...
                    <div class="col-md-12" >
                        ...
                        <el-table
                            ...
                            <el-table-column  :render-header="filterstrDoc_Trans_Num"
                            prop="strDoc_Trans_Num" width="100" label="Num. Transaccion">                                            
                            </el-table-column> 
                            <el-table-column :render-header="filterstrTypeMov_Cod"
                            prop="strTypeMov_Cod" label="Tipo Movimiento" width="130" align="center">                                
                            </el-table-column>
                            <el-table-column  :render-header="filterstrTypeMov_Desc"
                             prop="strTypeMov_Desc" min-width="200" label="Descripcion">
                            </el-table-column>
    ...
    <b-modal ref="myModalRef" hide-footer title="Inactivar Tipo Movimiento" size="sm"  v-model="planDialog" @keydown.native.enter="inactivarPlan">
      <div style="height:85px">
        <img src="../../../../../images/informacion.png" style="width:14px; height:15px; cursor: pointer;font: 0px/100% Arial, Helvetica, sans-serif;margin-left: 0.3rem;"/>
        <span style="font-size:13px">¿Desea Inactivar Tipo Movimiento {{documento.strTypeMov_Cod}} ?</span>
      </div>
      <footer class="modal-footer">
    ...
    <b-modal ref="myModalRef" hide-footer title="Activar Tipo Movimiento" size="sm"  v-model="planActivarDialog" @keydown.native.enter="activarPlan">
      <div style="height:85px">
        <img src="../../../../../images/informacion.png" style="width:14px; height:15px; cursor: pointer;font: 0px/100% Arial, Helvetica, sans-serif;margin-left: 0.3rem;"/>
        <span style="font-size:13px">¿Desea Activar Tipo Movimiento {{documento.strTypeMov_Cod}} ?</span>
      </div>
      <footer class="modal-footer">
...
<script>
import ViewAndEditTipoMovimientoComponent from '@/components/XX-CONFI/maestro_datos/tipo_movimiento/viewandedit_tipo_movimiento/viewandedit_tipo_movimiento.component'
export default ViewAndEditTipoMovimientoComponent
</script>
<style scoped>
