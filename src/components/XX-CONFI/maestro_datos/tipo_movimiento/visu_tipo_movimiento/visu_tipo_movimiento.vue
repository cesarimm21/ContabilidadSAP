<template>
    <div class="visualizar-tipomovimiento">
        ...
        <el-card class="box-card">
            <div slot="header" class="headercard">
                <span class="labelheadercard" > Visualizar Tipo Movimiento</span>
...
<script>
import VisuTipoMovimientoComponent from '@/components/XX-CONFI/maestro_datos/tipo_movimiento/visu_tipo_movimiento/visu_tipo_movimiento.component'
export default VisuTipoMovimientoComponent
</script>
<style scoped>
