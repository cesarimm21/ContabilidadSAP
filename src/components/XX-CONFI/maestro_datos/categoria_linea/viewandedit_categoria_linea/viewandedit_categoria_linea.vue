<template>
        ...
        <el-card class="box-card">
                ...
                <div class="container">
                    <div class="row" style="margin-top: 3px;">
                        <div class="col-sm-9">
                            ...
                            <div  class="form-group row ">
                                <label class="el-form-item__label col-md-2" >Cat. Linea</label>
                                <div class="col-md-2 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input class="validador" size ="small" v-model="strCategItem_Cod" style="text-transform: capitalize" type="text" @keydown.native.enter="validad()">  
                                    </el-input>
                                    </div>
                                </div>
                            </div>  
            ...
            <br/>
             <el-tabs type="border-card">
                <el-tab-pane>
                    <span slot="label"><i class="el-icon-date"></i> Categorias Lineas</span>                    
                    ...
                    <div class="col-md-12" >
                        ...
                        <el-table
                            ...
                            <el-table-column :render-header="filterstrCategItem_Cod"
                            prop="strCategItem_Cod" label="Cat. Linea" width="130" align="center">                                
                            </el-table-column>
                            <el-table-column  :render-header="filterstrCategItem_Desc"
                             prop="strCategItem_Desc" min-width="200" label="Descripcion">
                            </el-table-column>
    ...
    <b-modal ref="myModalRef" hide-footer title="Inactivar Categoria Linea" size="sm"  v-model="planDialog" @keydown.native.enter="inactivarPlan">
      <div style="height:85px">
        <img src="../../../../../images/informacion.png" style="width:14px; height:15px; cursor: pointer;font: 0px/100% Arial, Helvetica, sans-serif;margin-left: 0.3rem;"/>
        <span style="font-size:13px">¿Desea Inactivar Categoria Linea {{documento.strCategItem_Cod}} ?</span>
      </div>
      <footer class="modal-footer">
    ...
    <b-modal ref="myModalRef" hide-footer title="Activar Categoria Linea" size="sm"  v-model="planActivarDialog" @keydown.native.enter="activarPlan">
      <div style="height:85px">
        <img src="../../../../../images/informacion.png" style="width:14px; height:15px; cursor: pointer;font: 0px/100% Arial, Helvetica, sans-serif;margin-left: 0.3rem;"/>
        <span style="font-size:13px">¿Desea Activar Categoria Linea {{documento.strCategItem_Cod}} ?</span>
      </div>
      <footer class="modal-footer">
...
import ViewAndEditCategoriaLineaComponent from '@/components/XX-CONFI/maestro_datos/categoria_linea/viewandedit_categoria_linea/viewandedit_categoria_linea.component'
export default ViewAndEditCategoriaLineaComponent
</script>
<style scoped>
