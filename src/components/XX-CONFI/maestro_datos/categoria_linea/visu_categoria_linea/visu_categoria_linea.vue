    ...
    <div class="modificar-doctrans">
        ...
        <el-card class="box-card">
            <div slot="header" class="headercard">
                <span class="labelheadercard" > Visualizar Categoria Linea</span>
...
import VisuCategoriaLineaComponent from '@/components/XX-CONFI/maestro_datos/categoria_linea/visu_categoria_linea/visu_categoria_linea.component'
export default VisuCategoriaLineaComponent
</script>
<style scoped>
