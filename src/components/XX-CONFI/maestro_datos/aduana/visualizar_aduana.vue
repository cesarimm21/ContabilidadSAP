    ...
    <div class="crear-ingreso-comprobante">
        ...
        <el-card class="box-card">
            <div slot="header" class="headercard">
                <span class="labelheadercard" > Visualizar Aduana</span>
...
import VisualizarAduanaComponent from '@/components/XX-CONFI/maestro_datos/aduana/visualizar_aduana.component'
export default VisualizarAduanaComponent
</script>
<style scoped>
