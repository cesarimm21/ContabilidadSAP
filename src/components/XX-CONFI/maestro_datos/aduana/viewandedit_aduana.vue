                    ...
                    <div class="row" style="margin-top: 3px;">
                        <div class="col-sm-9">
                           ...
                           <div  class="form-group row ">
                                ...
                                <div class="col-md-2 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input class="validador" size ="small" v-model="documento.strCustom_Cod" style="text-transform: capitalize" type="text" :maxlength="1" :disabled="enabledtf">  
                                    </el-input>
                                    </div>
                                </div>
                            </div>    
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6 grupolabel">
                                    <div class="input-group mb-6" >
                                        <el-input  class="validador" size="small" v-model="documento.strCustom_Desc" :disabled="enabledtf" >
                                        </el-input>
                                    </div>
                                </div>
                            </div>
...
import ViewAndEditAduanaComponent from '@/components/XX-CONFI/maestro_datos/aduana/viewandedit_aduana.component'
export default ViewAndEditAduanaComponent
</script>
<style scoped>
   .sinLinea{
