    ...
    <div class="crear-ingreso-comprobante">
        ...
        <el-card class="box-card">
            <div slot="header" class="headercard">
                <span class="labelheadercard" > Crear Aduana</span>
                    ...
                    <div class="row" style="margin-top: 3px;">
                        <div class="col-sm-9">
                            ...
                            <div  class="form-group row ">
                                ...
                                <div class="col-md-2 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input class="validador" size ="small" v-model="aduana.strCustom_Cod" style="text-transform: capitalize" type="text" >  
                                    </el-input>
                                    </div>
                                </div>
                            </div>    
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6 grupolabel">
                                    <div class="input-group mb-6" >
                                        <el-input  class="validador" size="small" v-model="aduana.strCustom_Desc"  >
                                        </el-input>
                                    </div>
                                </div>
                            </div>
...
import CrearAduanaComponent from '@/components/XX-CONFI/maestro_datos/aduana/crear_aduana.component'
export default CrearAduanaComponent
</script>
<style scoped>
.sinLinea{
