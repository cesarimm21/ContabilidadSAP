    ...
    <div class="crear-ingreso-comprobante">
        ...
        <el-card class="box-card">
            <div slot="header" class="headercard">
                <span class="labelheadercard" > Crear Grupo Proceso</span>
                    ...
                    <div class="row" style="margin-top: 3px;">
                        <div class="col-sm-9">
                            ...
                            <div  class="form-group row ">
                                ...
                                <div class="col-md-2 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input class="validador" size ="small" v-model="grupoproceso.strCCGrpProc_Cod"  type="text">  
                                    </el-input>
                                    </div>
                                </div>
                            </div>  
                            ...
                            <div  class="form-group row ">
                                ...
                                <div class="col-md-6 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input class="validador" size ="small" v-model="grupoproceso.strCCGrpProc_Desc"  type="text">  
                                    </el-input>
                                    </div>
                                </div>
                            </div>           
...
import CrearGrupoProcesoComponent from '@/components/XX-CONFI/maestro_datos/grupo_proceso/crear_grupo_proceso/crear_grupo_proceso.component'
export default CrearGrupoProcesoComponent
</script>
<style scoped>
