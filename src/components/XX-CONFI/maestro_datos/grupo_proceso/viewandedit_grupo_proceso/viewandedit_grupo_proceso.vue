<template>
    <div class="modificar-doctrans">
        ...
        <el-card class="box-card">
            <div slot="header" class="headercard">
                <span class="labelheadercard" > Modificar Grupo Proceso</span>
                ...
                <div class="container">
                    <div class="row" style="margin-top: 3px;">
                        <div class="col-sm-9">
                            ...
                            <div  class="form-group row ">
                                <label class="el-form-item__label col-md-2" >Grupo Proceso</label>
                                <div class="col-md-2 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input class="validador" size ="small" v-model="strCCGrpProc_Cod" style="text-transform: capitalize" type="text" @keydown.native.enter="validad()">  
                                    </el-input>
                                    </div>
                                </div>
                            </div>  
            ...
            <br/>
             <el-tabs type="border-card">
                <el-tab-pane>
                    <span slot="label"><i class="el-icon-date"></i> Grupo Procesos</span>                    
                    ...
                    <div class="col-md-12" >
                        ...
                        <el-table
                            ...
                            <el-table-column :render-header="filterstrCCGrpProc_Cod"
                            prop="strCCGrpProc_Cod" label="Grupo Proceso" width="130" align="center">                                
                            </el-table-column>
                            <el-table-column  :render-header="filterstrCCGrpProc_Desc"
                             prop="strCCGrpProc_Desc" min-width="200" label="Descripcion">
                            </el-table-column>
    ...
    <b-modal ref="myModalRef" hide-footer title="Inactivar Grupo Proceso" size="sm"  v-model="planDialog" @keydown.native.enter="inactivarPlan">
      <div style="height:85px">
        <img src="../../../../../images/informacion.png" style="width:14px; height:15px; cursor: pointer;font: 0px/100% Arial, Helvetica, sans-serif;margin-left: 0.3rem;"/>
        <span style="font-size:13px">¿Desea Inactivar Grupo Proceso {{documento.strCCGrpProc_Cod}} ?</span>
      </div>
      <footer class="modal-footer">
    ...
    <b-modal ref="myModalRef" hide-footer title="Activar Grupo Proceso" size="sm"  v-model="planActivarDialog" @keydown.native.enter="activarPlan">
      <div style="height:85px">
        <img src="../../../../../images/informacion.png" style="width:14px; height:15px; cursor: pointer;font: 0px/100% Arial, Helvetica, sans-serif;margin-left: 0.3rem;"/>
        <span style="font-size:13px">¿Desea Activar Grupo Proceso {{documento.strCCGrpProc_Cod}} ?</span>
      </div>
      <footer class="modal-footer">
...
<script>
import ViewAndEditGrupoProcesoComponent from '@/components/XX-CONFI/maestro_datos/grupo_proceso/viewandedit_grupo_proceso/viewandedit_grupo_proceso.component'
export default ViewAndEditGrupoProcesoComponent
</script>
<style scoped>
