...
@Component({
  name: 'visualizar-diario',
  components:{
  'quickaccessmenu':QuickAccessMenuComponent,
  'buttons-accions': ButtonsAccionsComponent,
  }
})
export default class VisualizarCodigoDiarioComponent extends Vue {
  ...
  async validad(){      
    ...
    if(this.documento.intDaily_ID!=undefined){
      ...
      this.textosave='No existe Diario. ';
      this.warningMessage('No existe Diario. ');
    }
  }
   async validarView(){
      if(this.documento.intDaily_ID!=undefined){
          ...
          this.textosave='Seleccione Diario. ';
          this.warningMessage('Seleccione Diario. ');
        }
      }
    siguiente(){
