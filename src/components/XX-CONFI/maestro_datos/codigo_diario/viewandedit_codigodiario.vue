                    ...
                    <div class="row" style="margin-top: 3px;">
                        <div class="col-sm-9">
                            ...
                            <div  class="form-group row ">
                                ...
                                <div class="col-md-2 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input class="validador" size ="small" v-model="documento.strDaily_Cod" style="text-transform: capitalize" type="text" disabled >  
                                    </el-input>
                                    </div>
                                </div>
                            </div>    
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6 grupolabel">
                                    <div class="input-group mb-6" >
                                        <el-input  class="validador" size="small" v-model="documento.strDaily_Desc" :disabled="enabledtf" >
                                        </el-input>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-md-2 grupolabel">
                                    ...
                                    v-model="documento.strDaily_AccLocal" :disabled="enabledtf">
                                        <el-button v-if="btndocumentotransaccionA && !dialogDocumentoTransaccion" slot="append" class="boton" icon="fa fa-clone" @click="loadDocumentoTransaccion('A')" :disabled="enabledtf"></el-button> 
                                    </el-input>
                                    </div>
                                </div>
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-md-2 grupolabel">
                                    ...
                                    v-model="documento.strDaily_AccForen" :disabled="enabledtf">
                                        <el-button v-if="btndocumentotransaccionB && !dialogDocumentoTransaccion" slot="append" class="boton" icon="fa fa-clone" @click="loadDocumentoTransaccion('B')" :disabled="enabledtf"></el-button> 
                                    </el-input>
                                    </div>
                                </div>
...
import ViewAndEditCodigoDiarioComponent from '@/components/XX-CONFI/maestro_datos/codigo_diario/viewandedit_codigodiario.component'
export default ViewAndEditCodigoDiarioComponent
</script>
<style scoped>
   .sinLinea{
