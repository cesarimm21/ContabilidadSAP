    ...
    <div class="crear-ingreso-comprobante">
        ...
        <el-card class="box-card">
            <div slot="header" class="headercard">
                <span class="labelheadercard" > Crear Documento Transaccion</span>
...
import CrearDocumentoTransaccionComponent from '@/components/XX-CONFI/maestro_datos/documento_transaccion/crear_documento_transaccion/crear_documento_transaccion.component'
export default CrearDocumentoTransaccionComponent
</script>
<style scoped>
