    ...
    <div class="modificar-doctrans">
        ...
        <el-card class="box-card">
            <div slot="header" class="headercard">
                <span class="labelheadercard" > Visualizar Documento Transaccion</span>
...
import VisuDocumentoTransaccionComponent from '@/components/XX-CONFI/maestro_datos/documento_transaccion/visu_documento_transaccion/visu_documento_transaccion.component'
export default VisuDocumentoTransaccionComponent
</script>
<style scoped>
