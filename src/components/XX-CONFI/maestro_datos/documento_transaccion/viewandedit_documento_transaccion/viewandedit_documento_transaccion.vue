           ...
           <div class="container">
                <div class="row" style="margin-top: 3px;">
                    <div class="col-sm-9" >
                        ...
                        <div class="form-group row ">
                            <label class="el-form-item__label col-md-2" >Doc Transaccion</label>
                            <div class="col-md-2 grupolabel">
                                <div class="input-group mb-3" >
                                <el-input size ="small"  v-model="cod_documento_transaccion"  placeholder="">
                                </el-input>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12" >
                                <div class="row bodycard" style="background: white;margin-top: 0px;">
                                    <el-table
                                        ...
                                        <el-table-column  sortable prop="strDoc_Trans_Num" width="100" label="Num. Transaccion">
                                            <template scope="scope">
                                            <label v-bind:style="{width:'100%',margin: '0rem'}" >&nbsp;{{ scope.row.strDoc_Trans_Num }}</label>
                                            </template>
                                        </el-table-column> 
                                        <el-table-column
                                            prop="strDoc_Trans_Cod" sortable  
                                        ...
                                        <el-table-column
                                            prop="strDoc_Trans_Desc" sortable  
                                            label="Descripcion">
                                            <template scope="scope">
                                                <label v-bind:style="{width:'100%',margin: '0rem'}" >&nbsp;{{ scope.row.strDoc_Trans_Desc }}</label>
                                            </template>
                                        </el-table-column>
                                        <el-table-column
