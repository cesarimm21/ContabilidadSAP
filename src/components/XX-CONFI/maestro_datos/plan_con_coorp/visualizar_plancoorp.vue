    ...
    <div class="planconlocal">
        ...
        <el-card class="box-card">
            <div slot="header" class="headercard">
                <span class="labelheadercard" > Visualizar Plan Contable Coorporativo</span>
...
<script>
import VisualizarPlanCoorporativoComponent from '@/components/XX-CONFI/maestro_datos/plan_con_coorp/visualizar_plancoorp.component'
export default VisualizarPlanCoorporativoComponent
</script>
<style scoped>    
</style>
