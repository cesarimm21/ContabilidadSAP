                    ...
                    <div class="row" style="margin-top: 3px;">
                        <div class="col-sm-9">
                            ...
                            <div  class="form-group row ">
                                ...
                                <div class="col-md-2 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input class="validador" size ="small" v-model="region.strRegion_Cod"  type="text">  
                                    </el-input>
                                    </div>
                                </div>
                            </div>    
...
import CrearRegionComponent from '@/components/XX-CONFI/maestro_datos/region/crear_region/crear_region.component'
