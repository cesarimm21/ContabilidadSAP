                    ...
                    <div class="row" style="margin-top: 3px;">
                        <div class="col-sm-9">
                            ...
                            <div  class="form-group row ">
                                ...
                                <div class="col-md-2 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input class="validador" :disabled="true" size ="small" v-model="region.strRegion_Cod"  type="text">  
                                    </el-input>
                                    </div>
                                </div>
                            </div>    
...
<script>
import ModificarRegionComponent from '@/components/XX-CONFI/maestro_datos/region/modif_region/modif_region.component'
