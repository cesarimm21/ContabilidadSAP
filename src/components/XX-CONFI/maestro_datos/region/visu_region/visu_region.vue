  ...
  <div class="al-crear">
    ...
    <el-card class="box-card">
        <div slot="header" class="headercard">
            <span class="labelheadercard" >Visualizar Region</span>
        </div>
...
import VisuRegionComponent from '@/components/XX-CONFI/maestro_datos/region/visu_region/visu_region.component'
export default VisuRegionComponent
</script>
