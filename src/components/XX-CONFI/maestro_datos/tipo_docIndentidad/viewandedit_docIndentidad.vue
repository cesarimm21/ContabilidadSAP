                ...
                <div class="container">
                    <div class="row" style="margin-top: 3px;">
                        <div class="col-sm-9">
                           ...
                           <div  class="form-group row ">
                                <label class="el-form-item__label col-md-2" >Documento</label>
                                <div class="col-md-2 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input class="validador" size ="small" v-model="documento.strDocIdent_NO" style="text-transform: capitalize" type="text" :maxlength="1" :disabled="enabledtf">  
                                    </el-input>
                                    </div>
                                </div>
                            </div>    
...
import ViewAndEditDocIdentidadComponent from '@/components/XX-CONFI/maestro_datos/tipo_docIndentidad/viewandedit_docIndentidad.component'
export default ViewAndEditDocIdentidadComponent
</script>
<style scoped>
   .sinLinea{
