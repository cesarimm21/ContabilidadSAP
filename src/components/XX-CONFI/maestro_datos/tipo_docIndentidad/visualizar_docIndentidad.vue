    ...
    <div class="docidentidad">
        ...
        <el-card class="box-card">
            <div slot="header" class="headercard">
                <span class="labelheadercard" > Visualizar Tipo Doc. Identidad</span>
            ...
            <br/>
             <el-tabs type="border-card">
                <el-tab-pane>
                    <span slot="label"><i class="el-icon-date"></i>Visualizar Tipo Doc. Identidades</span>                    
...
<script>
import VisualizarTDocIdentidadComponent from '@/components/XX-CONFI/maestro_datos/tipo_docIndentidad/visualizar_docIndentidad.component'
export default VisualizarTDocIdentidadComponent
</script>
<style scoped>
