    ...
    <div class="crear-ingreso-comprobante">
        ...
        <el-card class="box-card">
            <div slot="header" class="headercard">
                <span class="labelheadercard" > Crear Tipo Doc. Identidad</span>
                    ...
                    <div class="row" style="margin-top: 3px;">
                        <div class="col-sm-9">
                            ...
                            <div  class="form-group row ">
                                ...
                                <div class="col-md-2 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input class="validador" size ="small" v-model="documento.strDocIdent_NO" style="text-transform: capitalize" type="text" :maxlength="5" :autofocus="true">  
                                    </el-input>
                                    </div>
                                </div>
                            </div>    
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4 grupolabel">
                                    <div class="input-group mb-3" >
                                        <el-input class="validador" size="small" v-model="documento.strDocIdent_Desc"  >
                                        </el-input>
                                    </div>
                                </div>
                            </div>
...
import CrearDocIdentidadComponent from '@/components/XX-CONFI/maestro_datos/tipo_docIndentidad/crear_docIndentidad.component'
export default CrearDocIdentidadComponent
</script>
<style scoped>
.sinLinea{
