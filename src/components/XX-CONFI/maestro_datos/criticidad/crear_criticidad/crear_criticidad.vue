    ...
    <div class="crear-ingreso-comprobante">
        ...
        <el-card class="box-card">
            <div slot="header" class="headercard">
                <span class="labelheadercard" > Crear Criticidad</span>
                    ...
                    <div class="row" style="margin-top: 3px;">
                        <div class="col-sm-9">
                            ...
                            <div  class="form-group row ">
                                ...
                                <div class="col-md-2 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input class="validador" size ="small" v-model="criticidad.strCritical_Cod"  type="text">  
                                    </el-input>
                                    </div>
                                </div>
                            </div>    
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6 grupolabel">
                                    <div class="input-group mb-3" >
                                        <el-input class="validador" size="small" v-model="criticidad.strCritical_Desc"  >
                                        </el-input>
                                    </div>
                                </div>
                            </div>           
...
import CrearCriticidadComponent from '@/components/XX-CONFI/maestro_datos/criticidad/crear_criticidad/crear_criticidad.component'
export default CrearCriticidadComponent
</script>
<style scoped>
