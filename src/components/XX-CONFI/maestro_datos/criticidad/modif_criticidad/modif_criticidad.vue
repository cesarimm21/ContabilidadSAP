                    ...
                    <div class="row" style="margin-top: 3px;">
                        <div class="col-sm-9">
                            ...
                            <div  class="form-group row ">
                                ...
                                <div class="col-md-2 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input :disabled="true" class="validador" size ="small" v-model="criticidad.strCritical_Cod"  type="text">  
                                    </el-input>
                                    </div>
                                </div>
                            </div>    
                            <div class="form-group row">
                                ...
                                <div class="col-sm-2 grupolabel">
                                    <div class="input-group mb-3" >
                                        <el-input class="validador"  size="small" :disabled="visualizar" v-model="criticidad.strCritical_Desc" >
                                        </el-input>
                                    </div>
                                </div>
                            </div>           
...
import ModificarCriticidadComponent from '@/components/XX-CONFI/maestro_datos/criticidad/modif_criticidad/modif_criticidad.component'
export default ModificarCriticidadComponent
</script>
<style scoped>
