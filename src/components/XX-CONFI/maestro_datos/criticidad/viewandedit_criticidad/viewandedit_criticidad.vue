<template>
    <div class="modificar-criticidad">
    ...
    <b-modal ref="myModalRef" hide-footer title="Inactivar Criticidad" size="sm"  v-model="planDialog" @keydown.native.enter="inactivarPlan">
      <div style="height:85px">
        <img src="../../../../../images/informacion.png" style="width:14px; height:15px; cursor: pointer;font: 0px/100% Arial, Helvetica, sans-serif;margin-left: 0.3rem;"/>
        <span style="font-size:13px">¿Desea Inactivar Criticidad {{documento.strCritical_Cod}} ?</span>
      </div>
      <footer class="modal-footer">
    ...
    <b-modal ref="myModalRef" hide-footer title="Activar Criticidad" size="sm"  v-model="planActivarDialog" @keydown.native.enter="activarPlan">
      <div style="height:85px">
        <img src="../../../../../images/informacion.png" style="width:14px; height:15px; cursor: pointer;font: 0px/100% Arial, Helvetica, sans-serif;margin-left: 0.3rem;"/>
        <span style="font-size:13px">¿Desea Activar Criticidad {{documento.strCritical_Cod}} ?</span>
      </div>
      <footer class="modal-footer">
...
<script>
import ViewAndEditCriticidadComponent from '@/components/XX-CONFI/maestro_datos/criticidad/viewandedit_criticidad/viewandedit_criticidad.component'
export default ViewAndEditCriticidadComponent
</script>
<style scoped>
