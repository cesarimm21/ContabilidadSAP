                        ...
                        <div class="col-sm-9">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4 grupolabel">
                                    <div class="input-group mb-3" >
                                        <el-input class="validador" size="small" v-model="moneda.strCurrency_Desc" :disabled="enabledtf" >
                                        </el-input>
                                    </div>
                                </div>
                            </div>
                            <div  class="form-group row ">
                                ...
                                <div class="col-md-2 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input class="validador" size ="small" @blur="desactivar_pais" @focus="activar_pais" v-model="moneda.strCountry" :disabled="enabledtf">                            
                                        <el-button v-if="btnactivarpais && !paisVisible" slot="append" class="boton" icon="fa fa-clone" @click="paisDialog()" :disabled="enabledtf"></el-button> 
                                    </el-input>
                                    </div>
                                </div>
                            </div>  
...
<script>
import ViewAndEditMonedaComponent from '@/components/XX-CONFI/maestro_datos/moneda/viewandedit_moneda.component'
export default ViewAndEditMonedaComponent
</script>
<style scoped>
   .sinLinea{
