<template>
    <div class="crear-idioma">
        ...
        <el-card class="box-card">
            <div slot="header" class="headercard">
                <span class="labelheadercard" > Modificar Idioma</span>
            ...
            <br/>
             <el-tabs type="border-card">
                <el-tab-pane>
                    <span slot="label"><i class="el-icon-date"></i> Idiomas</span>                    
                    ...
                    <div class="col-md-12" >
                        ...
                        <el-table
                            ...
                            <el-table-column :render-header="filterstrLenguaje_Cod"
                            prop="strLenguaje_Cod" label="Idioma" width="130" align="center">                                
                            </el-table-column>
                            <el-table-column  :render-header="filterstrLenguaje_Desc"
                             prop="strLenguaje_Desc" min-width="200" label="Descripcion">
                            </el-table-column>
    ...
    <b-modal ref="myModalRef" hide-footer title="Inactivar Idioma" size="sm"  v-model="planDialog" @keydown.native.enter="inactivarPlan">
      <div style="height:85px">
        <img src="../../../../images/informacion.png" style="width:14px; height:15px; cursor: pointer;font: 0px/100% Arial, Helvetica, sans-serif;margin-left: 0.3rem;"/>
        <span style="font-size:13px">¿Desea Inactivar la Idioma {{documento.strLenguaje_Cod}} ?</span>
      </div>
      <footer class="modal-footer">
    ...
    <b-modal ref="myModalRef" hide-footer title="Activar Idioma" size="sm"  v-model="planActivarDialog" @keydown.native.enter="activarPlan">
      <div style="height:85px">
        <img src="../../../../images/informacion.png" style="width:14px; height:15px; cursor: pointer;font: 0px/100% Arial, Helvetica, sans-serif;margin-left: 0.3rem;"/>
        <span style="font-size:13px">¿Desea Activar la Idioma {{documento.strLenguaje_Cod}} ?</span>
      </div>
      <footer class="modal-footer">
...
import ModificarIdiomaComponent from '@/components/XX-CONFI/maestro_datos/idioma/modificar_idioma.component'
export default ModificarIdiomaComponent
</script>
<style scoped>
