    ...
    <div class="crear-idioma">
        ...
        <el-card class="box-card">
            <div slot="header" class="headercard">
                <span class="labelheadercard" > Crear Idioma</span>
                    ...
                    <div class="row" style="margin-top: 3px;">
                        <div class="col-sm-9">
                            ...
                            <div  class="form-group row ">
                                ...
                                <div class="col-md-2 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input class="validador" size ="small" v-model="planconlocal.strLenguaje_Cod" style="text-transform: capitalize" type="text" >  
                                    </el-input>
                                    </div>
                                </div>
                            </div>    
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6 grupolabel">
                                    <div class="input-group mb-6" >
                                        <el-input  class="validador" size="small" v-model="planconlocal.strLenguaje_Desc"  >
                                        </el-input>
                                    </div>
                                </div>
                            </div>
...
import CrearIdiomaComponent from '@/components/XX-CONFI/maestro_datos/idioma/crear_idioma.component'
export default CrearIdiomaComponent
</script>
<style scoped>
.sinLinea{
