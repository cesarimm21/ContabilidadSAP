    ...
    <div class="planconlocal">
        ...
        <el-card class="box-card">
            <div slot="header" class="headercard">
                <span class="labelheadercard" > Visualizar Idioma</span>
                    ...
                    <div class="row" style="margin-top: 3px;">
                        <div class="col-sm-9">
                            ...
                            <div  class="form-group row ">
                                ...
                                <div class="col-md-2 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input class="validador" size ="small" v-model="strLenguaje_Cod" style="text-transform: capitalize" type="text" @keydown.native.enter="validad()">  
                                    </el-input>
                                    </div>
                                </div>
                            </div>  
...
<script>
import VisualizarIdiomaComponent from '@/components/XX-CONFI/maestro_datos/idioma/visualizar_idioma.component'
export default VisualizarIdiomaComponent
</script>
<style scoped>    
</style>
