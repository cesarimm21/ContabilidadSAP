...
export default class ViewAndEditIdiomaComponent extends Vue {
  ...
  constructor(){    
        super();
        Global.nameComponent='viewandedit-idioma';
        setTimeout(() => {
            this.load();
          }, 200)
    }  
    load(){
        ...
        if(vista=='modificar'){
            ...
            this.textTitle='Modificar Idioma';
        }
        if(vista=='visualizar'){
            this.enabledtf=true;
            this.textTitle='Visualizar Idioma';
        }
    ...
    guardarTipoDocIdent(){
      ...
      if(vista=='modificar'){
        ...
        if(this.documento.strLenguaje_Cod!=''&&this.documento.strLenguaje_Desc!=''){
          idiomaService.updatetblIdioma(this.documento)
          .then(resp=>{
