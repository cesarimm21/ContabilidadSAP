    ...
    <div class="crear-ingreso-comprobante">
        ...
        <el-card class="box-card">
            <div slot="header" class="headercard">
                <span class="labelheadercard" > Crear Tipo de Renta</span>
                    ...
                    <div class="row" style="margin-top: 3px;">
                        <div class="col-sm-9">
                            ...
                            <div  class="form-group row ">
                                ...
                                <div class="col-md-2 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input class="validador" size ="small" v-model="tiporenta.strReveType_Cod"  type="text">  
                                    </el-input>
                                    </div>
                                </div>
                            </div>    
                            <div  class="form-group row ">
                                ...
                                <div class="col-md-6 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input class="validador" size ="small" v-model="tiporenta.strReveType_Desc"  type="text">  
                                    </el-input>
                                    </div>
                                </div>
                            </div>    
...
import CrearTipoRentaComponent from '@/components/XX-CONFI/maestro_datos/tipo_renta/crear_tipo_renta/crear_tipo_renta.component'
export default CrearTipoRentaComponent
</script>
<style scoped>
