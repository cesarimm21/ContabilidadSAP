                    ...
                    <div class="row" style="margin-top: 3px;">
                        <div class="col-sm-9">
                            ...
                            <div  class="form-group row ">
                                ...
                                <div class="col-md-2 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input class="validador" :disabled="true" size ="small" v-model="tiporenta.strReveType_Cod"  type="text">  
                                    </el-input>
                                    </div>
                                </div>
                            </div>    
                            <div  class="form-group row ">
                                ...
                                <div class="col-md-6 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input class="validador" size ="small" :disabled="visualizar" v-model="tiporenta.strReveType_Desc"  type="text">  
                                    </el-input>
                                    </div>
                                </div>
                            </div>    
...
<script>
import ModificarTipoRentaComponent from '@/components/XX-CONFI/maestro_datos/tipo_renta/modif_tipo_renta/modif_tipo_renta.component'
export default ModificarTipoRentaComponent
</script>
<style scoped>
