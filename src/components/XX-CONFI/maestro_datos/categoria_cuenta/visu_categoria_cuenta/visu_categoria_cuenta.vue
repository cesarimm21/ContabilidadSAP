  ...
  <div class="al-crear">
    ...
    <el-card class="box-card">
        <div slot="header" class="headercard">
            <span class="labelheadercard" >Visualizar Categoria Cuenta</span>
        </div>
...
import VisuCategoriaCuentaComponent from '@/components/XX-CONFI/maestro_datos/categoria_cuenta/visu_categoria_cuenta/visu_categoria_cuenta.component'
export default VisuCategoriaCuentaComponent
</script>
