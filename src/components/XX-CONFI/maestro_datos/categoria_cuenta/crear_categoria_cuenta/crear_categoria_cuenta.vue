    ...
    <div class="crear-ingreso-comprobante">
        ...
        <el-card class="box-card">
            <div slot="header" class="headercard">
                <span class="labelheadercard" > Crear Categoria Cuenta</span>
                        ...
                        <div class="col-sm-9">
                            ...
                            <div  class="form-group row ">
                                ...
                                <div class="col-md-6 grupolabel">
                                    ...
                                    <el-input class="validador" size ="small" v-model="categoriacuenta.strAcctCateg_Desc"  type="text">  
                                    </el-input>
                                    </div>
                                </div>
                            </div>    
...
import CrearCategoriaCuentaComponent from '@/components/XX-CONFI/maestro_datos/categoria_cuenta/crear_categoria_cuenta/crear_categoria_cuenta.component'
export default CrearCategoriaCuentaComponent
</script>
<style scoped>
