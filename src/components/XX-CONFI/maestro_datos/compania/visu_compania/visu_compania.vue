                            ...
                            <div class="col-md-12" >
                                <div class="row bodycard" style="background: white;margin-top: 0px;">
                                    <el-table
                                        ...
                                        <el-table-column  sortable prop="strCompany_Cod" width="100" label="Compañia">
                                            <template scope="scope">
                                            <label v-bind:style="{width:'100%',margin: '0rem'}" >&nbsp;{{ scope.row.strCompany_Cod }}</label>
                                            </template>
                                        </el-table-column> 
                                        <el-table-column
                                            prop="strCompany_Desc" sortable  
                                            label="Descripcion">
                                            <template scope="scope">
...
import VisuCompaniaComponent from '@/components/XX-CONFI/maestro_datos/compania/visu_compania/visu_compania.component'
export default VisuCompaniaComponent
</script>
