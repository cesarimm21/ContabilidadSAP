    ...
    <div class="crear-ingreso-comprobante">
        ...
        <el-card class="box-card">
            <div slot="header" class="headercard">
                <span class="labelheadercard" > Crear Compania</span>
                        ...
                        <div class="col-sm-9">
                            ...
                            <div  class="form-group row ">
                                ...
                                <div class="col-md-6 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input class="validador" size ="small" v-model="compania.strCompany_Desc"  type="text">  
                                    </el-input>
                                    </div>
                                </div>
                            </div>    
                            <div  class="form-group row ">
                                ...
                                <div class="col-md-2 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input class="validador" size ="small" v-model="compania.strRUC"  type="text">  
                                    </el-input>
                                    </div>
                                </div>
                            </div>    
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6 grupolabel">
                                    <div class="input-group mb-3" >
                                        <el-input class="validador" size="small" v-model="compania.strAddress"  >
                                        </el-input>
                                    </div>
                                </div>
                            </div>           
...
import CrearCompaniaComponent from '@/components/XX-CONFI/maestro_datos/compania/crear_compania/crear_compania.component'
