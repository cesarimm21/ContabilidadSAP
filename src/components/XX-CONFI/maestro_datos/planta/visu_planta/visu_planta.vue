  ...
  <div class="al-crear">
    ...
    <el-card class="box-card">
        <div slot="header" class="headercard">
            <span class="labelheadercard" >Visualizar Planta</span>
        </div>
...
import VisuPlantaComponent from '@/components/XX-CONFI/maestro_datos/planta/visu_planta/visu_planta.component'
export default VisuPlantaComponent
</script>
