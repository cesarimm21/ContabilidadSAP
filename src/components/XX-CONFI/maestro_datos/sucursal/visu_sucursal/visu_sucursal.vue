  ...
  <div class="al-crear">
    ...
    <el-card class="box-card">
        <div slot="header" class="headercard">
            <span class="labelheadercard" >Visualizar Sucursal</span>
        </div>
                ...
                <div class="row" style="margin-top: 3px;">
                    <div class="col-sm-9" >
                        ...
                        <div class="form-group row ">
                            ...
                            <div class="col-md-2 grupolabel">
                                <div class="input-group mb-3" >
                                <el-input size ="small"  v-model="cod_sucursal"  placeholder="">
                                </el-input>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12" >
                                <div class="row bodycard" style="background: white;margin-top: 0px;">
                                    <el-table
                                        ...
                                        <el-table-column  sortable prop="strSubsidiary_Cod" width="100" label="Sucursal">
                                            <template scope="scope">
                                            <label v-bind:style="{width:'100%',margin: '0rem'}" >&nbsp;{{ scope.row.strSubsidiary_Cod }}</label>
                                            </template>
                                        </el-table-column> 
                                        <el-table-column
                                            prop="strSubsidiary_Desc" sortable  
                                            label="Descripcion">
                                            <template scope="scope">
                                        ...
                                        <el-table-column
                                            prop="strSubsidiary_Address" sortable  
                                            label="Direccion">
                                            <template scope="scope">
...
import VisuSucursalComponent from '@/components/XX-CONFI/maestro_datos/sucursal/visu_sucursal/visu_sucursal.component'
export default VisuSucursalComponent
</script>
