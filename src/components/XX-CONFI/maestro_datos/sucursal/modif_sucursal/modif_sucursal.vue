                    ...
                    <div class="row" style="margin-top: 3px;">
                        <div class="col-sm-9">
                            ...
                            <div  class="form-group row ">
                                ...
                                <div class="col-md-2 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input class="validador" :disabled="true" size ="small" v-model="sucursal.strSubsidiary_Cod"  type="text">  
                                    </el-input>
                                    </div>
                                </div>
                            </div>    
...
import ModificarSucursalComponent from '@/components/XX-CONFI/maestro_datos/sucursal/modif_sucursal/modif_sucursal.component'
export default ModificarSucursalComponent
</script>
<style scoped>
