                    ...
                    <div class="row" style="margin-top: 3px;">
                        <div class="col-sm-9">
                           ...
                           <div  class="form-group row ">
                                ...
                                <div class="col-md-2 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input class="validador" size ="small" v-model="documento.strTypeAdq_PDB_Cod" style="text-transform: capitalize" type="text" :maxlength="1" :disabled="enabledtf">  
                                    </el-input>
                                    </div>
                                </div>
                            </div>    
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6 grupolabel">
                                    <div class="input-group mb-6" >
                                        <el-input  class="validador" size="small" v-model="documento.strTypeAdq_PDB_Desc" :disabled="enabledtf" >
                                        </el-input>
                                    </div>
                                </div>
                            </div>
...
import ViewAndEditAdquisicionComponent from '@/components/XX-CONFI/maestro_datos/tipo_adquisicion/viewandedit_adquisicion.component'
export default ViewAndEditAdquisicionComponent
</script>
<style scoped>
   .sinLinea{
