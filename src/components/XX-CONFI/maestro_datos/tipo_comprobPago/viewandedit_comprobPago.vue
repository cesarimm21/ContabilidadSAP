                    ...
                    <div class="row" style="margin-top: 3px;">
                        <div class="col-sm-9">
                           ...
                           <div  class="form-group row ">
                                ...
                                <div class="col-md-2 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input class="validador" size ="small" v-model="documento.strDocType_Cod" style="text-transform: capitalize" type="text" :maxlength="1" :disabled="enabledtf">  
                                    </el-input>
                                    </div>
                                </div>
                            </div>    
...
import ViewAndEditComprobPagoComponent from '@/components/XX-CONFI/maestro_datos/tipo_comprobPago/viewandedit_comprobPago.component'
export default ViewAndEditComprobPagoComponent
</script>
<style scoped>
   .sinLinea{
