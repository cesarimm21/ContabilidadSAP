<template>
    <div class="visualizar-tipocomprobantepago">
        ...
        <el-card class="box-card">
            <div slot="header" class="headercard">
                <span class="labelheadercard" >Visualizar Tipo de Comprobante Pago</span>
...
import VisualizarComprobPagoComponent from '@/components/XX-CONFI/maestro_datos/tipo_comprobPago/visualizar_comprobPago.component'
export default VisualizarComprobPagoComponent
</script>
<style scoped>
