    ...
    <div class="crear-ingreso-comprobante">
        ...
        <el-card class="box-card">
            <div slot="header" class="headercard">
                <span class="labelheadercard" > Crear Tipo de Comprobante Pago</span>
...
import CrearComprobPagoComponent from '@/components/XX-CONFI/maestro_datos/tipo_comprobPago/crear_comprobPago.component'
export default CrearComprobPagoComponent
</script>
<style scoped>
.sinLinea{
