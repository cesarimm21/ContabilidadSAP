...
<template>
    <div class="visualizar-categoria-centro-costos">
        ...
        <el-card class="box-card">
            <div slot="header" class="headercard">
                <span class="labelheadercard" > Visualizar Categoria Centro Costo</span>
                    ...
                    <div class="row" style="margin-top: 3px;">
                        <div class="col-sm-9">
                            ...
                            <div  class="form-group row ">
                                ...
                                <div class="col-md-2 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input :autofocus="true" class="validador" size ="small" v-model="strCCCategory_Cod" style="text-transform: capitalize" type="text" @keydown.native.enter="validad()">  
                                    </el-input>
                                    </div>
                                </div>
                            </div>  
...
<script>
import VisuCategoriaCentroCostoComponent from '@/components/XX-CONFI/maestro_datos/categoria_centro_costo/visu_categoria_centro_costo/visu_categoria_centro_costo.component'
export default VisuCategoriaCentroCostoComponent
</script>
<style scoped>
