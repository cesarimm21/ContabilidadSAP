<template>
    <div class="modificar-categoria-centro-costos">
        ...
        <el-card class="box-card">
            <div slot="header" class="headercard">
                <span class="labelheadercard" > Modificar Categoria Centro Costo</span>
                ...
                <div class="container">
                    <div class="row" style="margin-top: 3px;">
                        <div class="col-sm-9">
                            ...
                            <div  class="form-group row ">
                                <label class="el-form-item__label col-md-2" >Categoria CC.</label>
                                <div class="col-md-2 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input class="validador" size ="small" v-model="strCCCategory_Cod" style="text-transform: capitalize" type="text" @keydown.native.enter="validad()">  
                                    </el-input>
                                    </div>
                                </div>
                            </div>  
            ...
            <br/>
             <el-tabs type="border-card">
                <el-tab-pane>
                    <span slot="label"><i class="el-icon-date"></i> Categoria Centro Costos</span>                    
                    ...
                    <div class="col-md-12" >
                        ...
                        <el-table
                            ...
                            <el-table-column :render-header="filterstrCCCategory_Cod"
                            prop="strCCCategory_Cod" label="Categoria CC." width="130" align="center">                                
                            </el-table-column>
                            <el-table-column  :render-header="filterstrCCCategory_Desc"
                             prop="strCCCategory_Desc" min-width="200" label="Descripcion">
                            </el-table-column>
    ...
    <b-modal ref="myModalRef" hide-footer title="Inactivar Categoria Centro Costo" size="sm"  v-model="planDialog" @keydown.native.enter="inactivarPlan">
      <div style="height:85px">
        <img src="../../../../../images/informacion.png" style="width:14px; height:15px; cursor: pointer;font: 0px/100% Arial, Helvetica, sans-serif;margin-left: 0.3rem;"/>
        <span style="font-size:13px">¿Desea Inactivar Categoria Centro Costoes {{documento.strCCCategory_Cod}} ?</span>
      </div>
      <footer class="modal-footer">
    ...
    <b-modal ref="myModalRef" hide-footer title="Activar Categoria Centro Costo" size="sm"  v-model="planActivarDialog" @keydown.native.enter="activarPlan">
      <div style="height:85px">
        <img src="../../../../../images/informacion.png" style="width:14px; height:15px; cursor: pointer;font: 0px/100% Arial, Helvetica, sans-serif;margin-left: 0.3rem;"/>
        <span style="font-size:13px">¿Desea Activar Categoria Centro Costoes {{documento.strCCCategory_Cod}} ?</span>
      </div>
      <footer class="modal-footer">
...
<script>
import ViewAndEditCategoriaCentroCostoComponent from '@/components/XX-CONFI/maestro_datos/categoria_centro_costo/viewandedit_categoria_centro_costo/viewandedit_categoria_centro_costo.component'
export default ViewAndEditCategoriaCentroCostoComponent
</script>
<style scoped>
