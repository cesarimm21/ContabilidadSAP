...
<template>
    <div class="modificar-metododepreciacion">
        ...
        <el-card class="box-card">
                    ...
                    <div class="row" style="margin-top: 3px;">
                        <div class="col-sm-9">
                            ...
                            <div  class="form-group row ">
                                ...
                                <div class="col-md-2 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input class="validador" size ="small" v-model="strDeprMeth_Cod" style="text-transform: capitalize" type="text" @keydown.native.enter="validad()">  
                                    </el-input>
                                    </div>
                                </div>
                            </div>  
            ...
            <br/>
             <el-tabs type="border-card">
                <el-tab-pane>
                    <span slot="label"><i class="el-icon-date"></i> Metodo Depreciacion</span>                    
                    ...
                    <div class="col-md-12" >
                        ...
                        <el-table
                            ...
                            prop="strDeprMeth_Cod" label="Metodo Depreciacion" width="130" align="center">                                
                            </el-table-column>
    ...
    <b-modal ref="myModalRef" hide-footer title="Inactivar Metodo Depreciacion" size="sm"  v-model="planDialog" @keydown.native.enter="inactivarPlan">
      <div style="height:85px">
        <img src="../../../../images/informacion.png" style="width:14px; height:15px; cursor: pointer;font: 0px/100% Arial, Helvetica, sans-serif;margin-left: 0.3rem;"/>
        <span style="font-size:13px">¿Desea Inactivar Metodo Depreciacion {{documento.strDeprMeth_Cod}} ?</span>
      </div>
      <footer class="modal-footer">
    ...
    <b-modal ref="myModalRef" hide-footer title="Activar Metodo Depreciacion" size="sm"  v-model="planActivarDialog" @keydown.native.enter="activarPlan">
      <div style="height:85px">
        <img src="../../../../images/informacion.png" style="width:14px; height:15px; cursor: pointer;font: 0px/100% Arial, Helvetica, sans-serif;margin-left: 0.3rem;"/>
        <span style="font-size:13px">¿Desea Activar Metodo Depreciacion {{documento.strDeprMeth_Cod}} ?</span>
      </div>
      <footer class="modal-footer">
