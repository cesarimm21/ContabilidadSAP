<template>
    <div class="crear-ingreso-comprobante">
        ...
        <el-card class="box-card">
            <div slot="header" class="headercard">
                <span class="labelheadercard" > Modificar Metodo Depreciacion</span>
                ...
                <div class="container">
                    <div class="row" style="margin-top: 3px;">
                        <div class="col-sm-9">
                            ...
                            <div  class="form-group row ">
                                <label class="el-form-item__label col-md-2" >Metodo Depreciacion</label>
                                <div class="col-md-2 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input class="validador" size ="small" v-model="strDeprMeth_Cod" style="text-transform: capitalize" type="text" >  
                                    </el-input>
                                    </div>
                                </div>
                            </div>  
            ...
            <br/>
             <el-tabs type="border-card">
                <el-tab-pane>
                    <span slot="label"><i class="el-icon-date"></i> Tipos de Metodo Depreciacion</span>                    
                    <buttons-accions  v-on:ActivarDesactivar="ActivarDesactivar" v-on:validarView="validarView()" v-on:Limpiar="Limpiar" v-on:Print="Print" v-on:Buscar="Buscar" v-on:AscItem="AscItem" v-on:DscItem="DscItem" v-on:EliminarItem="EliminarItem()" v-on:siguiente="siguiente()" v-on:anterior="anterior()"></buttons-accions>
                    <div class="col-md-12" >
                        ...
                        <el-table
                            ...
                            <el-table-column :render-header="filterstrDeprMeth_Cod"
                            prop="strDeprMeth_Cod" label="Metodo Depreciacion" width="120" align="center">                                
                            </el-table-column>
                            <el-table-column  :render-header="filterstrDeprMeth_Desc"
                             prop="strDeprMeth_Desc" min-width="200" label="Descripcion">
                            </el-table-column>
    ...
    <b-modal ref="myModalRef" hide-footer title="Eliminar Metodo Depreciacion" size="sm"  v-model="metodoDialog" @keydown.native.enter="deleteServicio">
      <div style="height:85px">
        <img src="../../../../images/informacion.png" style="width:14px; height:15px; cursor: pointer;font: 0px/100% Arial, Helvetica, sans-serif;margin-left: 0.3rem;"/>
        <span style="font-size:13px">¿Desea eliminar la Metodo Depreciacion {{documento.strNDServ_Cod}} ?</span>
      </div>
      <footer class="modal-footer">
        <img src="../../../../images/check.png" style="width:13px; height:15px; cursor: pointer;font: 0px/100% Arial, Helvetica, sans-serif;margin-left: 0.6rem;" @click="deleteServicio()"/>
        <img src="../../../../images/close.png" style="width:17px; height:15px; cursor: pointer;font: 0px/100% Arial, Helvetica, sans-serif;margin-left: 0.6rem;" @click="metodoDialog = false"/>
      </footer>
    </b-modal>  
    ...
    <b-modal ref="myModalRef" hide-footer title="Activar" size="sm"  v-model="dialogInactivar" @keydown.native.enter="btnInactivar">
      <div style="height:85px"> 
        ...
        <span style="font-size:13px">¿Desea Activar Metodo Depreciacion {{item}}?</span>
      </div>
      <footer class="modal-footer">
...
import ModificarMetodoDepComponent from '@/components/XX-CONFI/maestro_datos/meto_depresacion/modificar_metododep.component'
export default ModificarMetodoDepComponent
</script>
<style scoped>
