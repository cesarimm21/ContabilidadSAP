...
import ModificarPeriodoComponent from '@/components/XX-CONFI/maestro_datos/periodo/edit_periodo/edit_periodo.component'
export default ModificarPeriodoComponent
</script>
<style scoped>
