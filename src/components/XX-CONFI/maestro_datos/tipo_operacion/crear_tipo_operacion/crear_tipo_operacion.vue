    ...
    <div class="crear-ingreso-comprobante">
        ...
        <el-card class="box-card">
            <div slot="header" class="headercard">
                <span class="labelheadercard" > Crear Tipo Operacion</span>
                    ...
                    <div class="row" style="margin-top: 3px;">
                        <div class="col-sm-9">
                            ...
                            <div  class="form-group row ">
                                ...
                                <div class="col-md-2 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input class="validador" size ="small" v-model="tipooperacion.strTypeOper_Cod"  type="text">  
                                    </el-input>
                                    </div>
                                </div>
                            </div>    
                            <div  class="form-group row ">
                                ...
                                <div class="col-md-4 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input class="validador" size ="small" v-model="tipooperacion.strTypeOper_Desc"  type="text">  
                                    </el-input>
                                    </div>
                                </div>
                            </div>    
...
import CrearTipoOperacionComponent from '@/components/XX-CONFI/maestro_datos/tipo_operacion/crear_tipo_operacion/crear_tipo_operacion.component'
export default CrearTipoOperacionComponent
</script>
<style scoped>
