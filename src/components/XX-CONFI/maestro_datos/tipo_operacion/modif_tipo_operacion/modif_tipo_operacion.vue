                    ...
                    <div class="row" style="margin-top: 3px;">
                        <div class="col-sm-9">
                            ...
                            <div  class="form-group row ">
                                ...
                                <div class="col-md-2 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input class="validador" :disabled='true' size ="small" v-model="tipooperacion.strTypeOper_Cod"  type="text">  
                                    </el-input>
                                    </div>
                                </div>
                            </div>    
                            <div  class="form-group row ">
                                ...
                                <div class="col-md-6 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input class="validador" size ="small" :disabled='visualizar' v-model="tipooperacion.strTypeOper_Desc"  type="text">  
                                    </el-input>
                                    </div>
                                </div>
                            </div>    
...
<script>
import ModificarTipoOperacionComponent from '@/components/XX-CONFI/maestro_datos/tipo_operacion/modif_tipo_operacion/modif_tipo_operacion.component'
export default ModificarTipoOperacionComponent
</script>
<style scoped>
