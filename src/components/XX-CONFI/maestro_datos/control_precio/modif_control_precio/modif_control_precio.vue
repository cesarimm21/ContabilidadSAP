                    ...
                    <div class="row" style="margin-top: 3px;">
                        <div class="col-sm-9">
                            ...
                            <div  class="form-group row ">
                                ...
                                <div class="col-md-2 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input class="validador" :disabled='true' size ="small" v-model="controlprecio.strCtlPrec_Cod"  type="text">  
                                    </el-input>
                                    </div>
                                </div>
                            </div>    
                            <div  class="form-group row ">
                                ...
                                <div class="col-md-2 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input class="validador" :disabled="visualizar" size ="small" v-model="controlprecio.strCtlPrec_Desc"  type="text">  
                                    </el-input>
                                    </div>
                                </div>
                            </div>    
...
import ModificarControlPrecioComponent from '@/components/XX-CONFI/maestro_datos/control_precio/modif_control_precio/modif_control_precio.component'
export default ModificarControlPrecioComponent
</script>
<style scoped>
