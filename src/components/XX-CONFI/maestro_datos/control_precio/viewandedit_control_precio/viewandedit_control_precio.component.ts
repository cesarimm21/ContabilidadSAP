...
@Component({
  name: 'viewandedit-control-precio',
  components:{
  ...
  constructor(){    
    ...
    async validarView(){
        ...
        if(this.selectrow!=undefined && this.selectrow!=null ){
            debugger;
            if(this.selectrow!=undefined && this.selectrow!=null ){
                router.push({ path: `/barmenu/XX-CONFI/maestro_datos/control_precio/modif_control_precio`, query: { vista: 'modificar',data:JSON.stringify(this.selectrow) }  })
            }
        }
        else{
