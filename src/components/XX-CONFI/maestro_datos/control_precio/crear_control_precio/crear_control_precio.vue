    ...
    <div class="crear-ingreso-comprobante">
        ...
        <el-card class="box-card">
            <div slot="header" class="headercard">
                <span class="labelheadercard" > Crear Control Precio</span>
                    ...
                    <div class="row" style="margin-top: 3px;">
                        <div class="col-sm-9">
                            ...
                            <div  class="form-group row ">
                                ...
                                <div class="col-md-2 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input class="validador" size ="small" v-model="controlprecio.strCtlPrec_Cod"  type="text">  
                                    </el-input>
                                    </div>
                                </div>
                            </div>    
                            <div  class="form-group row ">
                                ...
                                <div class="col-md-2 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input class="validador" size ="small" v-model="controlprecio.strCtlPrec_Desc"  type="text">  
                                    </el-input>
                                    </div>
                                </div>
                            </div>    
...
import CrearControlPrecioComponent from '@/components/XX-CONFI/maestro_datos/control_precio/crear_control_precio/crear_control_precio.component'
export default CrearControlPrecioComponent
</script>
<style scoped>
