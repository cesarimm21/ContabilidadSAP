  ...
  <div class="al-crear">
    ...
    <el-card class="box-card">
        <div slot="header" class="headercard">
            <span class="labelheadercard" >Modificar Tipo Producto</span>
        </div>
...
import ViewAndEditTipoProductoComponent from '@/components/XX-CONFI/maestro_datos/tipo_producto/viewandedit_tipo_producto/viewandedit_tipo_producto.component'
export default ViewAndEditTipoProductoComponent
</script>
