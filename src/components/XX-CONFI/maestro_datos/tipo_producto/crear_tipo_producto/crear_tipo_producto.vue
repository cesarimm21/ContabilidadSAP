    ...
    <div class="crear-ingreso-comprobante">
        ...
        <el-card class="box-card">
            <div slot="header" class="headercard">
                <span class="labelheadercard" > Crear Tipo Producto</span>
...
import CrearTipoProductoComponent from '@/components/XX-CONFI/maestro_datos/tipo_producto/crear_tipo_producto/crear_tipo_producto.component'
export default CrearTipoProductoComponent
</script>
<style scoped>
