                    ...
                    <div class="row" style="margin-top: 3px;">
                        <div class="col-sm-9">
                            ...
                            <div  class="form-group row ">
                                ...
                                <div class="col-md-2 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input class="validador" :disabled="true" size ="small" v-model="tipoproducto.strTypeProd_Cod"  type="text">  
                                    </el-input>
                                    </div>
                                </div>
                            </div>    
                            <div  class="form-group row ">
                                ...
                                <div class="col-md-2 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input class="validador" :disabled="visualizar" size ="small" v-model="tipoproducto.strTypeProd_Desc"  type="text">  
                                    </el-input>
                                    </div>
                                </div>
                            </div>    
...
import ModificarTipoProductoComponent from '@/components/XX-CONFI/maestro_datos/tipo_producto/modif_tipo_producto/modif_tipo_producto.component'
export default ModificarTipoProductoComponent
</script>
<style scoped>
