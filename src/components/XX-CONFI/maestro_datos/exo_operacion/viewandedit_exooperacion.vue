                        ...
                        <div class="col-sm-9">
                            <div class="form-group row ">
                                ...
                                <div class="col-md-2 grupolabel">
                                    ...
                                    <el-input size ="small"  @blur="desactivar_compania" @focus="activar_compania" v-model="documento.strCompany_Cod"  placeholder="">
                           ...
                           <div  class="form-group row ">
                                ...
                                <div class="col-md-2 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input class="validador" size ="small" v-model="documento.strNDExonIR_Cod" style="text-transform: capitalize" type="text" :maxlength="1" :disabled="enabledtf">  
                                    </el-input>
                                    </div>
                                </div>
                            </div>    
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6 grupolabel">
                                    <div class="input-group mb-6" >
                                        <el-input  class="validador" size="small" v-model="documento.strNDExonIR_Desc" :disabled="enabledtf" >
                                        </el-input>
                                    </div>
                                </div>
                            </div>
...
import ViewAndEditExoOperacionComponent from '@/components/XX-CONFI/maestro_datos/exo_operacion/viewandedit_exooperacion.component'
export default ViewAndEditExoOperacionComponent
</script>
<style scoped>
   .sinLinea{
