...
import VisualizarExoOperacionComponent from '@/components/XX-CONFI/maestro_datos/exo_operacion/visualizar_exooperacion.component'
export default VisualizarExoOperacionComponent
</script>
<style scoped>
