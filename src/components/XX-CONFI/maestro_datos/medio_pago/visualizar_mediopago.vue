<template>
    <div class="visualizar-mediopago">
        ...
        <el-card class="box-card">
            <div slot="header" class="headercard">
                <span class="labelheadercard" > Visualizar Medio de Pago</span>
...
<script>
import VisualizarMedioPagoComponent from '@/components/XX-CONFI/maestro_datos/medio_pago/visualizar_mediopago.component'
export default VisualizarMedioPagoComponent
</script>
<style scoped>
