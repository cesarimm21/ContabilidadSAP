  ...
  <div class="al-crear">
    ...
    <el-card class="box-card">
        <div slot="header" class="headercard">
            <span class="labelheadercard" >Modificar Tipo Titulo</span>
        </div>
           ...
           <div class="container">
                <div class="row" style="margin-top: 3px;">
                    <div class="col-sm-9" >
                        ...
                        <div class="form-group row ">
                            <label class="el-form-item__label col-md-2" >Tipo Titulo</label>
                            <div class="col-md-2 grupolabel">
                                <div class="input-group mb-3" >
                                <el-input size ="small"  v-model="cod_tipotitulo"  placeholder="">
                                </el-input>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12" >
                                <div class="row bodycard" style="background: white;margin-top: 0px;">
                                    <el-table
                                        ...
                                        <el-table-column  sortable prop="strTitVal_Cod" width="100" label="Tipo Renta">
                                            <template scope="scope">
                                            <label v-bind:style="{width:'100%',margin: '0rem'}" >&nbsp;{{ scope.row.strTitVal_Cod }}</label>
                                            </template>
                                        </el-table-column> 
                                        <el-table-column
                                            prop="strTitVal_Desc" sortable  
                                            label="Descripcion">
                                            <template scope="scope">
                                                <label v-bind:style="{width:'100%',margin: '0rem'}" >&nbsp;{{ scope.row.strTitVal_Desc }}</label>
                                            </template>
                                        </el-table-column>
    ...
    <b-modal ref="myModalRef" hide-footer title="Activar" size="sm"  v-model="dialogInactivar" @keydown.native.enter="btnInactivar">
      <div style="height:85px"> 
        <img src="../../../../../images/tacho.png" style="width:14px; height:15px; cursor: pointer;font: 0px/100% Arial, Helvetica, sans-serif;margin-left: 0.3rem;"/>
        <span style="font-size:13px">¿Desea Activar Tipo Titulo {{item}}?</span>
      </div>
      <footer class="modal-footer">
...
import ViewAndEditTipoTituloComponent from '@/components/XX-CONFI/maestro_datos/tipo_titulo/viewandedit_tipo_titulo/viewandedit_tipo_titulo.component'
export default ViewAndEditTipoTituloComponent
</script>
