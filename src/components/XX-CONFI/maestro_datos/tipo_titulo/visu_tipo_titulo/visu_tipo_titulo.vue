  ...
  <div class="al-crear">
    ...
    <el-card class="box-card">
        <div slot="header" class="headercard">
            <span class="labelheadercard" >Visualizar Tipo Titulo</span>
        </div>
...
import VisuTipoTituloComponent from '@/components/XX-CONFI/maestro_datos/tipo_titulo/visu_tipo_titulo/visu_tipo_titulo.component'
export default VisuTipoTituloComponent
</script>
