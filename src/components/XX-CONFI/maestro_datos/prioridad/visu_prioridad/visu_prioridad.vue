<template>
    <div class="visualizar-prioridad">
        ...
        <el-card class="box-card">
            <div slot="header" class="headercard">
                <span class="labelheadercard" > Visualizar Prioridad</span>
                ...
                <div class="container">
                    <div class="row" style="margin-top: 3px;">
                        <div class="col-sm-9">
                            ...
                            <div  class="form-group row ">
                                <label class="el-form-item__label col-md-2" >Prioridad</label>
                                <div class="col-md-2 grupolabel">
                                    <div class="input-group mb-3" >
...
<script>
import VisuPrioridadComponent from '@/components/XX-CONFI/maestro_datos/prioridad/visu_prioridad/visu_prioridad.component'
export default VisuPrioridadComponent
</script>
<style scoped>
