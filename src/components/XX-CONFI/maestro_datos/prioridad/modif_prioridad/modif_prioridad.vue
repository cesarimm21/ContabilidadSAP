                    ...
                    <div class="row" style="margin-top: 3px;">
                        <div class="col-sm-9">
                            ...
                            <div  class="form-group row ">
                                ...
                                <div class="col-md-2 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input class="validador" :disabled="true" size ="small" v-model="prioridad.strPriority_Cod"  type="text">  
                                    </el-input>
                                    </div>
                                </div>
                            </div>    
...
import ModificarPrioridadComponent from '@/components/XX-CONFI/maestro_datos/prioridad/modif_prioridad/modif_prioridad.component'
export default ModificarPrioridadComponent
</script>
<style scoped>
