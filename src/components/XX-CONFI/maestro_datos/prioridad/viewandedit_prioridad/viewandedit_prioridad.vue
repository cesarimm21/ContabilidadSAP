<template>
    <div class="modificar-prioridad">
        ...
        <el-card class="box-card">
            <div slot="header" class="headercard">
                <span class="labelheadercard" > Modificar Prioridad</span>
                    ...
                    <div class="row" style="margin-top: 3px;">
                        <div class="col-sm-9">
                            ...
                            <div  class="form-group row ">
                                ...
                                <div class="col-md-2 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input class="validador" size ="small" v-model="strPriority_Cod" style="text-transform: capitalize" type="text" @keydown.native.enter="validad()">  
                                    </el-input>
                                    </div>
                                </div>
                            </div>  
            ...
            <br/>
             <el-tabs type="border-card">
                <el-tab-pane>
                    <span slot="label"><i class="el-icon-date"></i> Prioridades</span>                    
                    ...
                    <div class="col-md-12" >
                        ...
                        <el-table
                            ...
                            prop="strPriority_Cod" label="Prioridad" width="130" align="center">                                
                            </el-table-column>
                            <el-table-column  :render-header="filterstrPriority_Desc"
                             prop="strPriority_Desc" min-width="200" label="Descripcion">
                            </el-table-column>
                            <el-table-column :render-header="filterintPriority_Days"
                                prop="intPriority_Days"   width="80"
                                label="Dias">
                            </el-table-column>
    ...
    <b-modal ref="myModalRef" hide-footer title="Inactivar Prioridad" size="sm"  v-model="planDialog" @keydown.native.enter="inactivarPlan">
      <div style="height:85px">
        <img src="../../../../../images/informacion.png" style="width:14px; height:15px; cursor: pointer;font: 0px/100% Arial, Helvetica, sans-serif;margin-left: 0.3rem;"/>
        <span style="font-size:13px">¿Desea Inactivar Prioridades {{documento.strPriority_Cod}} ?</span>
      </div>
      <footer class="modal-footer">
    ...
    <b-modal ref="myModalRef" hide-footer title="Activar Prioridad" size="sm"  v-model="planActivarDialog" @keydown.native.enter="activarPlan">
      <div style="height:85px">
        <img src="../../../../../images/informacion.png" style="width:14px; height:15px; cursor: pointer;font: 0px/100% Arial, Helvetica, sans-serif;margin-left: 0.3rem;"/>
        <span style="font-size:13px">¿Desea Activar Prioridades {{documento.strPriority_Cod}} ?</span>
      </div>
      <footer class="modal-footer">
...
<script>
import ViewAndEditPrioridadComponent from '@/components/XX-CONFI/maestro_datos/prioridad/viewandedit_prioridad/viewandedit_prioridad.component'
export default ViewAndEditPrioridadComponent
</script>
<style scoped>
