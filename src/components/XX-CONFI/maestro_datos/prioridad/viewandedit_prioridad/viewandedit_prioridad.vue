...
<template>
  ...
  <div class="al-crear">
                ...
                <div class="row" style="margin-top: 3px;">
                    <div class="col-sm-9" >
                        ...
                        <div class="form-group row ">
                            ...
                            <div class="col-md-2 grupolabel">
                                <div class="input-group mb-3" >
                                <el-input size ="small"  v-model="cod_prioridad"  placeholder="">
                                </el-input>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12" >
                                <div class="row bodycard" style="background: white;margin-top: 0px;">
                                    <el-table
                                        ...
                                        <el-table-column  sortable prop="strPriority_Cod" width="100" label="Prioridad">
                                            <template scope="scope">
                                            <label v-bind:style="{width:'100%',margin: '0rem'}" >&nbsp;{{ scope.row.strPriority_Cod }}</label>
                                            </template>
                                        </el-table-column> 
                                        <el-table-column
                                            prop="strPriority_Desc" sortable  
                                            label="Descripcion">
                                            <template scope="scope">
    ...
    <b-modal ref="myModalRef" hide-footer title="Activar" size="sm"  v-model="dialogInactivar" @keydown.native.enter="btnInactivar">
      <div style="height:85px"> 
        <img src="../../../../../images/tacho.png" style="width:14px; height:15px; cursor: pointer;font: 0px/100% Arial, Helvetica, sans-serif;margin-left: 0.3rem;"/>
        <span style="font-size:13px">¿Desea Activar Prioridad {{item}}?</span>
      </div>
      <footer class="modal-footer">
