    ...
    <div class="crear-ingreso-comprobante">
        ...
        <el-card class="box-card">
            <div slot="header" class="headercard">
                <span class="labelheadercard" > Crear Prioridad</span>
                    ...
                    <div class="row" style="margin-top: 3px;">
                        <div class="col-sm-9">
                            ...
                            <div  class="form-group row ">
                                ...
                                <div class="col-md-2 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input class="validador" size ="small" v-model="prioridad.strPriority_Cod"  type="text">  
                                    </el-input>
                                    </div>
                                </div>
                            </div>    
                            <div  class="form-group row ">
                                ...
                                <div class="col-md-2 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input class="validador" size ="small" v-model="prioridad.strPriority_Desc"  type="text">  
                                    </el-input>
                                    </div>
                                </div>
                            </div>   
...
import CrearPrioridadComponent from '@/components/XX-CONFI/maestro_datos/prioridad/crear_prioridad/crear_prioridad.component'
export default CrearPrioridadComponent
</script>
<style scoped>
