                    ...
                    <div class="row" style="margin-top: 3px;">
                        <div class="col-sm-9">
                           ...
                           <div  class="form-group row ">
                                ...
                                <div class="col-md-2 grupolabel">
                                    <div class="input-group mb-3" >
                                    <el-input class="validador" size ="small" v-model="documento.strNDServ_Cod" style="text-transform: capitalize" type="text" :disabled="enabledtf">  
                                    </el-input>
                                    </div>
                                </div>
                            </div>    
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6 grupolabel">
                                    <div class="input-group mb-6" >
                                        <el-input  class="validador" size="small" v-model="documento.strNDServ_Desc" :disabled="enabledtf" >
                                        </el-input>
                                    </div>
                                </div>
                            </div>
...
import ViewAndEditServicioComponent from '@/components/XX-CONFI/maestro_datos/servicio_prestado/viewandedit_servicio.component'
export default ViewAndEditServicioComponent
</script>
<style scoped>
   .sinLinea{
