    ...
    <div>
       <el-card class="box-card">
            <div slot="header" class="headercard">
                <span class="labelheadercard" > Categoria Linea</span>
            </div>
            ...
            <el-table-column :render-header="filterstrCategItem_Cod"  prop="strCategItem_Cod" label="Codigo" width="180">
            </el-table-column>  
            <el-table-column :render-header="filterstrCategItem_Desc" prop="strCategItem_Desc" label="Descripcion" style="width: 70% !important;">
            </el-table-column> 
            </el-table>
        </el-card>
        <br/>
...
<script>
    import BCategoriaLineaComponent from '@/components/buscadores/b_categoria_linea/b_categoria_linea.component'
    export default BCategoriaLineaComponent
</script>
