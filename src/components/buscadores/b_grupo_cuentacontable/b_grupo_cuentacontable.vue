<template>
    <div>
       <el-card class="box-card">
            ...
            <el-table-column   prop="strGrpAcctCont_Cod" label="Código" width="180">
            </el-table-column>  
            <el-table-column  prop="strGrpAcctCont_Name" label="Nombre" style="width: 70% !important;">
            </el-table-column>  
            <el-table-column  prop="strGrpAcctCont_Desc" label="Descripción" style="width: 70% !important;">
            </el-table-column> 
            </el-table>
        </el-card>
        <br/>
...
<script>
    import BGrupoCuentaContableComponent from '@/components/buscadores/b_grupo_cuentacontable/b_grupo_cuentacontable.component'
    export default BGrupoCuentaContableComponent
</script>
