<template>
    <div>
       <el-card class="box-card">
            ...
            <el-table-column   prop="intTypeAdq_PDB_Cod" label="Codigo" width="180">
            </el-table-column>  
            <el-table-column  prop="strTypeAdq_PDB_Desc" label="Descripción" style="width: 70% !important;">
            </el-table-column> 
            </el-table>
        </el-card>
        <br/>
...
<script>
    import BTipoAdquisicionComponent from '@/components/buscadores/b_tipo_adquisicion/b_tipo_adquisicion.component'
    export default BTipoAdquisicionComponent
</script>
