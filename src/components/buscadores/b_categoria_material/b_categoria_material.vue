<template>
    <div>
       <el-card class="box-card">
            ...
            <!-- @current-change="handleCurrentChange"> -->
            <el-table-column :render-header="filterstrCategMat_Cod"  prop="strCategMat_Cod" label="Codigo" width="180">
            </el-table-column>  
            <el-table-column :render-header="filterstrCategMat_Desc" prop="strCategMat_Desc" label="Descripcion" style="width: 70% !important;">
            </el-table-column> 
            </el-table>
        </el-card>
        <br/>
...
<script>
    import BCategoriaMaterialComponent from '@/components/buscadores/b_categoria_material/b_categoria_material.component'
    export default BCategoriaMaterialComponent
</script>
