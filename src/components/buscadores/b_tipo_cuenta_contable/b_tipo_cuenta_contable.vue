<template>
    <div>
       <el-card class="box-card">
            ...
            <el-table-column   prop="strAcc_Type_Cod" label="Codigo" width="180">
            </el-table-column>  
            <el-table-column  prop="strAcc_Type_Name" label="Descripción" style="width: 70% !important;">
            </el-table-column> 
            </el-table>
        </el-card>
        <br/>
...
<script>
    import BTipoCuentaContableComponent from '@/components/buscadores/b_tipo_cuenta_contable/b_tipo_cuenta_contable.component'
    export default BTipoCuentaContableComponent
</script>
