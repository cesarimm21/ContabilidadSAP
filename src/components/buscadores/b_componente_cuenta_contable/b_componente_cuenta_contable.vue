    ...
    <div>
        <el-card class="box-card">
            ...
            @current-change="handleCurrentChange">
                ...
                <el-table-column :render-header="filterstrComp_Desc"  prop="strComp_Desc" label="Descripcion" style="width: 70% !important;">
                </el-table-column> 
            </el-table>
        </el-card>
        <br/>
...
<script>
    import BComponenteCuentaContableComponent from '@/components/buscadores/b_componente_cuenta_contable/b_componente_cuenta_contable.component'
    export default BComponenteCuentaContableComponent
</script>
