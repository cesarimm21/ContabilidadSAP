<template>
    <div>
       <el-card class="box-card">
            ...
            <el-table-column   prop="Vendor_NO" label="Codigo" width="180">
            </el-table-column>  
            <el-table-column  prop="Vendor_Desc" label="Descripción" style="width: 70% !important;">
            </el-table-column> 
            <el-table-column  prop="Country" label="Ciudad" style="width: 70% !important;">
            </el-table-column> 
            </el-table>
        </el-card>
        <br/>
...
<script>
    import BProveedorComponent from '@/components/buscadores/b_proveedor/b_proveedor.component'
    export default BProveedorComponent
</script>
