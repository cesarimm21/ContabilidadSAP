<template>
    <div>
       <el-card class="box-card">
                ...
                <div class="col-md-12">
                    <div class="form-group row">
                        ...
                        <div class="col-md-2 grupolabel">
                            ...
                            <el-input size ="small" v-model="inputAtributo" :autofocus="true" @keydown.native.enter="buscarTipod()">
            ...
            <el-table-column  :render-header="filterstrDocIdent_NO" prop="strDocIdent_NO" label="Codigo" width="120">
            </el-table-column>  
            <el-table-column :render-header="filterstrDocIdent_Name" prop="strDocIdent_Name" label="Descripcion" style="width: 70% !important;">
            </el-table-column> 
            </el-table>
        </el-card>
        <br/>
