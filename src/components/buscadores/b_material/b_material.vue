<template>
    <div>
       <el-card class="box-card">
            ...
            <el-table-column   prop="Stock_Cod" label="Codigo" width="180">
            </el-table-column>  
            <el-table-column  prop="Stock_Desc" label="Descripción" style="width: 70% !important;">
            </el-table-column> 
            <el-table-column  prop="Exp_Acct" label="Cuenta" style="width: 70% !important;">
            </el-table-column> 
            </el-table>
        </el-card>
        <br/>
...
<script>
    import BMaterialComponent from '@/components/buscadores/b_material/b_material.component'
    export default BMaterialComponent
</script>
