    ...
    <div>
       <el-card class="box-card">
            <div slot="header" class="headercard">
                <span class="labelheadercard" >Grupo Centro de Costos</span>
            </div>
                ...
                <div class="col-md-12">
                    <div class="form-group row">
                        ...
                        <div class="col-md-2 grupolabel">
                            ...
                            <el-input size ="small" v-model="inputAtributo" :autofocus="true" @keydown.native.enter="buscarGrupoCC()">
...
<script>
    import BGrupoCentroCostoComponent from '@/components/buscadores/b_grupo_centrocosto/b_grupo_centrocosto.component'
    export default BGrupoCentroCostoComponent
</script>
