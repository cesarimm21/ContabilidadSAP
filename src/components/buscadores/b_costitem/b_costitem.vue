    ...
    <div>
        <el-card class="box-card">
            ...
            @current-change="handleCurrentChange">
                <el-table-column :render-header="filterstrCost_Item_Cod"   prop="strCost_Item_Cod" label="Cuenta Local" width="180">
                </el-table-column>  
                <el-table-column :render-header="filterstrCost_Item_Pos1" prop="strCost_Item_Pos1" label="Cuenta Corporativa" style="width: 70% !important;">
                </el-table-column>  
                <el-table-column :render-header="filterstrCost_Item_Desc1"  prop="strCost_Item_Desc1" label="Nombre" style="width: 70% !important;">
                </el-table-column> 
            </el-table>
        </el-card>
        <br/>
...
<script>
    import BCostItemComponent from '@/components/buscadores/b_costitem/b_costitem.component'
    export default BCostItemComponent
</script>
