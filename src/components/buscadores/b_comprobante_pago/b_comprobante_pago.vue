<template>
    <div>
       <el-card class="box-card">
                ...
                <div class="col-md-12">
                    <div class="form-group row">
                        ...
                        <div class="col-md-3 grupolabel">
                            ...
                            <el-input size ="small" v-model="inputAtributo" :autofocus="true" @keydown.native.enter="buscarComprobante()">
            ...
            <el-table-column  :render-header="filterstrDocType_Cod" prop="strDocType_Cod" label="Codigo" width="120">
            </el-table-column>  
            <el-table-column :render-header="filterstrDocType_Desc" prop="strDocType_Desc" label="Descripcion" style="width: 70% !important;">
            </el-table-column>  
            </el-table>
        </el-card>
        <br/>
