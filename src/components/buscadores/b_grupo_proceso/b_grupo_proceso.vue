<template>
    <div>
       <el-card class="box-card">
            ...
            <el-table-column   prop="strCCGrpProc_Cod" label="Codigo" width="180">
            </el-table-column>  
            <el-table-column  prop="strCCGrpProc_Desc" label="Nombre" style="width: 70% !important;">
            </el-table-column>  
            </el-table>
        </el-card>
        <br/>
...
<script>
    import BGrupoProcesoComponent from '@/components/buscadores/b_grupo_proceso/b_grupo_proceso.component'
    export default BGrupoProcesoComponent
</script>
