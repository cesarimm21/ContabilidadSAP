<template>
    <div>
       <el-card class="box-card">
            ...
            <el-table-column   prop="strSubsidiary_Cod" label="Codigo" width="100">
            </el-table-column>  
            <el-table-column  prop="strSubsidiary_Desc" label="Descripcion" style="width: 70% !important;">
            </el-table-column> 
            <el-table-column  prop="strSubsidiary_Address" label="Direccion" style="width: 70% !important;">
            </el-table-column> 
            </el-table>
        </el-card>
        <br/>
