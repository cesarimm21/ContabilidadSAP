...
import ModificarEmpleadoComponent from '@/components/HR-Planilla/empleado/empleado_modificar/empleado_modificar.component'
export default ModificarEmpleadoComponent
</script>
<style scoped>
