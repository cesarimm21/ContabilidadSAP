    ...
    <div class="crear-ingreso-comprobante">
        ...
        <el-card class="box-card">
            <div slot="header" class="headercard">
                <span class="labelheadercard" > Crear Empleado</span>
            ...
            <div class="row">
                <div class="col-sm-12" >
                    <el-tabs type="border-card"  style="margin-left: -10px;">
                        <el-tab-pane>
                            <span slot="label"><i class="el-icon-date"></i> Datos generales</span>
                            <el-card class="box-card">
                                <div class="row bodycard">
                                    <div class="container">
                                        <div class="row" style="margin-top: 3px;">
                                            <div class="col-sm-6" style="margin-top: 10px;">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-3 grupolabel">
                                                        <div class="input-group mb-3" >
                                                            <el-input size ="small" @blur="desactivar_CuentaContableDebe" @focus="activar_CuentaContableDebe" v-model="centrocosto.strAcctDest_Debit"  placeholder="">
                        ...
                        <el-tab-pane>
                            <span slot="label"><i class="el-icon-date"></i> Datos laborales</span>
                            <el-card class="box-card">
                                <div class="row bodycard">
                                    <div class="container">
                                        <div class="row" style="margin-top: 3px;">
                        ...
                        <el-tab-pane>
                            <span slot="label"><i class="el-icon-date"></i> Planilla</span>
                            <el-card class="box-card">
                                <div class="row bodycard">
                                    <div class="container">
                                        <div class="row" style="margin-top: 3px;">
                        ...
                        <el-tab-pane>
                            <span slot="label"><i class="el-icon-date"></i> Datos Familiares</span>
                            <el-card class="box-card">
                                <div class="row bodycard">
                                    <div class="container">
                                        <div class="row" style="margin-top: 3px;">
...
import CrearEmpleadoComponent from '@/components/HR-Planilla/empleado/empleado_crear/empleado_crear.component'
export default CrearEmpleadoComponent
</script>
<style scoped>
